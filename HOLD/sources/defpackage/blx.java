...
public final class blx extends atg {
    ...
    private final bma o = new bma(this.n);
    private final bmj p;
    ...
    public blx(Context context, ati ati, Handler handler, bmk bmk) {
        ...
        this.p = new bmj(handler, bmk);
        this.q = "NVIDIA".equals(blm.c);
        this.r = new long[10];
        this.s = new long[10];
    ...
    public final int a(atd atd, akh akh, akh akh2) {
        ...
        int i = akh2.n;
        blu blu = this.t;
        if (i > blu.a || akh2.o > blu.b || a(atd, akh2) > this.t.c) {
            return 0;
        }
        return akh.b(akh2) ? 3 : 2;
    }

    private final void E() {
        MediaCodec mediaCodec;
        this.z = false;
        if (blm.a >= 23 && this.R && (mediaCodec = this.g) != null) {
            this.f = new blv(this, mediaCodec);
        }
    }
    ...
    private static final boolean a(java.lang.String r7) {
        /*
            ...
            java.lang.Class<blx> r7 = defpackage.blx.class
            monitor-enter(r7)
            boolean r1 = defpackage.blx.l     // Catch:{ all -> 0x0662 }
            if (r1 != 0) goto L_0x065e
            int r1 = defpackage.blm.a     // Catch:{ all -> 0x0662 }
            r2 = 27
            r3 = 1
            if (r1 > r2) goto L_0x0031
            java.lang.String r1 = "dangal"
            java.lang.String r4 = defpackage.blm.b     // Catch:{ all -> 0x0662 }
            ...
            goto L_0x0031
        L_0x002c:
            defpackage.blx.m = r3     // Catch:{ all -> 0x0662 }
            goto L_0x065b
        L_0x0031:
            int r1 = defpackage.blm.a     // Catch:{ all -> 0x0662 }
            if (r1 >= r2) goto L_0x065b
            java.lang.String r1 = defpackage.blm.b     // Catch:{ all -> 0x0662 }
        ...
        L_0x061c:
            defpackage.blx.m = r3     // Catch:{ all -> 0x0662 }
        L_0x061f:
            java.lang.String r1 = defpackage.blm.d     // Catch:{ all -> 0x0662 }
        ...
        L_0x0659:
            defpackage.blx.m = r3     // Catch:{ all -> 0x0662 }
        L_0x065b:
            defpackage.blx.l = r3     // Catch:{ all -> 0x0662 }
        L_0x065e:
            monitor-exit(r7)     // Catch:{ all -> 0x0662 }
            boolean r7 = defpackage.blx.m
            return r7
        L_0x0662:
            r0 = move-exception
            monitor-exit(r7)     // Catch:{ all -> 0x0662 }
        ...
        L_0x0665:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.blx.a(java.lang.String):boolean");
    }
    ...
    public final void a(atd atd, MediaCodec mediaCodec, akh akh, float f2) {
        ...
        if (length != 1) {
                ...
                if (!atd2.a(akh2, akh3, z3)) {
                    ...
                    if (i8 != -1) {
                        ...
                        if (akh3.o != -1) {
                            ...
                            i7 = Math.max(i7, akh3.o);
                            i5 = Math.max(i5, a(atd2, akh3));
                            i4 = max;
                            z4 = z5;
                        }
                    } else {
            ...
            if (z4) {
                ...
                while (true) {
                    ...
                    if (blm.a < 21) {
                        try {
                            int a4 = blm.a(i15, 16) << 4;
                            int a5 = blm.a(i16, 16) << 4;
                            if (a4 * a5 > att.a()) {
                                i = i9;
                            } else {
                        ...
                        MediaCodecInfo.CodecCapabilities codecCapabilities = atd2.d;
                        point = (codecCapabilities == null || (videoCapabilities = codecCapabilities.getVideoCapabilities()) == null) ? null : atd.a(videoCapabilities, i20, i16);
                        i = i9;
                        if (atd2.a(point.x, point.y, (double) akh2.p)) {
                            break;
                        }
                    }
                    i13++;
                ...
                if (point != null) {
                    ...
                    i5 = Math.max(i5, a(atd2, akh2.i, i4, i7));
            ...
            str = str2;
            if (!(a3 == -1 || (a2 = a(atd2, akh2.i, akh2.n, akh2.o)) == -1)) {
        ...
        mediaFormat.setInteger("width", akh2.n);
        mediaFormat.setInteger("height", akh2.o);
        buj.a(mediaFormat, akh2.k);
        float f4 = akh2.p;
        if (f4 != -1.0f) {
            mediaFormat.setFloat("frame-rate", f4);
        }
        buj.a(mediaFormat, "rotation-degrees", akh2.q);
        blp blp = akh2.u;
        if (blp != null) {
            buj.a(mediaFormat, "color-transfer", blp.c);
            buj.a(mediaFormat, "color-standard", blp.a);
            buj.a(mediaFormat, "color-range", blp.b);
            byte[] bArr = blp.d;
            if (bArr != null) {
                mediaFormat.setByteBuffer("hdr-static-info", ByteBuffer.wrap(bArr));
            }
        }
        if ("video/dolby-vision".equals(akh2.i) && (a = att.a(akh)) != null) {
            buj.a(mediaFormat, "profile", ((Integer) a.first).intValue());
        }
        mediaFormat.setInteger("max-width", blu.a);
        mediaFormat.setInteger("max-height", blu.b);
        buj.a(mediaFormat, "max-input-size", blu.c);
        if (blm.a >= 23) {
        ...
        if (this.w == null) {
            bks.b(b(atd));
            if (this.x == null) {
                this.x = bls.a(this.n, atd2.e);
            }
            this.w = this.x;
        }
        MediaCodec mediaCodec2 = mediaCodec;
        mediaCodec2.configure(mediaFormat, this.w, (MediaCrypto) null, 0);
        if (blm.a >= 23 && this.R) {
            this.f = new blv(this, mediaCodec2);
        }
    }

    /* access modifiers changed from: protected */
    public final ate a(Throwable th, atd atd) {
        return new blw(th, atd, this.w);
    }
    ...
    /* JADX INFO: Can't fix incorrect switch cases order, some code will duplicate */
    private static int a(atd atd, String str, int i, int i2) {
        char c;
        int i3;
        if (i == -1 || i2 == -1) {
            return -1;
        ...
        if (!(c == 0 || c == 1)) {
            ...
            } else if ("BRAVIA 4K 2015".equals(blm.d) || ("Amazon".equals(blm.c) && ("KFSOWI".equals(blm.d) || ("AFTS".equals(blm.d) && atd.e)))) {
                return -1;
            } else {
                i3 = (blm.a(i, 16) * blm.a(i2, 16)) << 8;
            }
            return (i3 * 3) / (i4 + i4);
        }
        i3 = i * i2;
    ...
    public final List b(ati ati, akh akh) {
        return a(ati, akh, false, this.R);
    }

    private static List a(ati ati, akh akh, boolean z2, boolean z3) {
        Pair a;
        String str = akh.i;
        if (str == null) {
            return Collections.emptyList();
        }
        List a2 = att.a(ati.a(str, z2, z3), akh);
        if ("video/dolby-vision".equals(str) && (a = att.a(akh)) != null) {
            int intValue = ((Integer) a.first).intValue();
            if (intValue == 16 || intValue == 256) {
                a2.addAll(ati.a("video/hevc", z2, z3));
            } else if (intValue == 512) {
                a2.addAll(ati.a("video/avc", z2, z3));
            }
        }
        return Collections.unmodifiableList(a2);
    }

    private static int a(atd atd, akh akh) {
        if (akh.j == -1) {
            return a(atd, akh.i, akh.n, akh.o);
        }
        int size = akh.k.size();
        int i = 0;
        for (int i2 = 0; i2 < size; i2++) {
            i += ((byte[]) akh.k.get(i2)).length;
        }
        return akh.j + i;
    }

    /* access modifiers changed from: protected */
    public final void b(anj anj) {
        if (this.v) {
            ByteBuffer byteBuffer = (ByteBuffer) bks.a(anj.e);
    ...
    public final void a(int i, Object obj) {
        if (i == 1) {
            ...
            if (this.w != surface) {
                ...
                MediaCodec mediaCodec = this.g;
                if (mediaCodec != null) {
                    if (blm.a < 23 || surface == null || this.u) {
                        A();
                        y();
                    } else {
    ...
    public final boolean v() {
        Surface surface;
        if (super.v() && (this.z || (((surface = this.x) != null && this.w == surface) || this.g == null || this.R))) {
            this.B = -9223372036854775807L;
            return true;
    ...
    public final void a(String str, long j, long j2) {
        bmj bmj = this.p;
        if (bmj.b != null) {
            bmj.a.post(new bmd(bmj, str, j, j2));
        }
        this.u = a(str);
        atd atd = (atd) bks.a(this.h);
        boolean z2 = false;
        if (blm.a >= 29 && "video/x-vnd.on2.vp9".equals(atd.b)) {
            MediaCodecInfo.CodecProfileLevel[] a = atd.a();
            int length = a.length;
            int i = 0;
            while (true) {
                if (i < length) {
    ...
    public final void r() {
        ...
        if (bma.a != null) {
            bly bly = bma.c;
            if (bly != null) {
                bly.a.unregisterDisplayListener(bly);
            }
            bma.b.c.sendEmptyMessage(2);
        }
        this.f = null;
        try {
            super.r();
    ...
    public final void a(boolean z2) {
        ...
        ani ani = this.j;
        if (bmj.b != null) {
            bmj.a.post(new bmc(bmj, ani));
        }
        bma bma = this.o;
        bma.i = false;
        if (bma.a != null) {
            bma.b.c.sendEmptyMessage(1);
            bly bly = bma.c;
            if (bly != null) {
                bly.a.registerDisplayListener(bly, null);
            }
            bma.a();
        }
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final boolean a(long r26, long r28, android.media.MediaCodec r30, java.nio.ByteBuffer r31, int r32, int r33, long r34, boolean r36, boolean r37) {
        /*
            r25 = this;
            r1 = r25
            r2 = r26
        ...
        L_0x0022:
            long r11 = r5 - r2
            android.view.Surface r8 = r1.w
            android.view.Surface r13 = r1.x
        ...
        L_0x01d2:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.blx.a(long, long, android.media.MediaCodec, java.nio.ByteBuffer, int, int, long, boolean, boolean):boolean");
    }
    ...
    /* access modifiers changed from: protected */
    public final boolean a(atd atd) {
        return this.w != null || b(atd);
    }

    private final boolean b(atd atd) {
        if (blm.a < 23 || this.R || a(atd.a)) {
            return false;
        }
        return !atd.e || bls.a(this.n);
    }
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     ...
     candidates:
      ...
      blx.a(ati, akh, boolean, boolean):java.util.List */
    /* access modifiers changed from: protected */
    public final int a(ati ati, akh akh) {
        int i;
        int i2 = 0;
        if (!bkt.b(akh.i)) {
            return 0;
        ...
        anq anq = akh.l;
        boolean z2 = anq != null;
        List a = a(ati, akh, z2, false);
        if (z2 && a.isEmpty()) {
            a = a(ati, akh, false, false);
        }
        if (a.isEmpty()) {
            return 1;
        }
        ...
        if (a2) {
            List a3 = a(ati, akh, z2, true);
            if (!a3.isEmpty()) {
                atd atd2 = (atd) a3.get(0);
                if (atd2.a(akh) && atd2.b(akh)) {
                    i2 = 32;
                }
            }
        }

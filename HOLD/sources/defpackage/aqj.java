...
final class aqj {
    ...
    public static akh a(int i, akh akh, atw atw, atw atw2, aom aom) {
        if (i == 1) {
            if (aom.a()) {
                akh = akh.a(aom.a, aom.b);
            }
            return atw != null ? akh.a(atw) : akh;
        } else if (i != 2 || atw2 == null) {
            return akh;
        } else {
            akh akh2 = akh;
            for (int i2 = 0; i2 < atw2.a(); i2++) {
                atv a2 = atw2.a(i2);
                if (a2 instanceof aqi) {
                    aqi aqi = (aqi) a2;
                    if ("com.android.capture.fps".equals(aqi.a) && aqi.c == 23) {
                        try {
                            akh2 = akh2.a(ByteBuffer.wrap(aqi.b).asFloatBuffer().get());
                            try {
                                akh2 = akh2.a(new atw(aqi));
    ...
    public static defpackage.atv a(defpackage.bky r12) {
        /*
            int r0 = r12.b
            int r1 = r12.j()
            int r0 = r0 + r1
        ...
        L_0x001b:
            ...
            int r1 = b(r12)     // Catch:{ all -> 0x020e }
            if (r1 <= 0) goto L_0x0037
            java.lang.String[] r2 = defpackage.aqj.a     // Catch:{ all -> 0x020e }
        ...
        L_0x004c:
            ...
            avk r1 = b(r2, r1, r12)     // Catch:{ all -> 0x020e }
        L_0x0058:
            r12.c(r0)
            return r1
        L_0x005c:
        ...
        L_0x0068:
            ...
            avc r1 = a(r2, r1, r12, r3, r8)     // Catch:{ all -> 0x020e }
            goto L_0x0058
        L_0x0076:
            r2 = 1668311404(0x6370696c, float:4.434815E21)
            if (r1 != r2) goto L_0x0082
            java.lang.String r1 = "TCMP"
            avc r1 = a(r2, r1, r12, r3, r3)     // Catch:{ all -> 0x020e }
            goto L_0x0058
        L_0x0082:
            r2 = 1668249202(0x636f7672, float:4.4173067E21)
            if (r1 != r2) goto L_0x00df
            int r1 = r12.j()     // Catch:{ all -> 0x020e }
            int r2 = r12.j()     // Catch:{ all -> 0x020e }
        ...
        L_0x0097:
            int r2 = r12.j()     // Catch:{ all -> 0x020e }
            int r2 = defpackage.apu.d(r2)     // Catch:{ all -> 0x020e }
            r3 = 13
        ...
        L_0x00c8:
            r2 = 4
            r12.d(r2)     // Catch:{ all -> 0x020e }
            int r1 = r1 + -16
            byte[] r2 = new byte[r1]     // Catch:{ all -> 0x020e }
            r12.a(r2, r8, r1)     // Catch:{ all -> 0x020e }
        ...
        L_0x00df:
            ...
            avk r1 = a(r2, r1, r12)     // Catch:{ all -> 0x020e }
            goto L_0x0058
        L_0x00ed:
        ...
        L_0x0155:
            ...
            avk r1 = a(r1, r2, r12)     // Catch:{ all -> 0x020e }
            goto L_0x0058
        L_0x0165:
            ...
            r4 = -1
        L_0x016e:
            int r8 = r12.b     // Catch:{ all -> 0x020e }
            if (r8 >= r0) goto L_0x01a7
            int r9 = r12.j()     // Catch:{ all -> 0x020e }
            int r10 = r12.j()     // Catch:{ all -> 0x020e }
            r11 = 4
            r12.d(r11)     // Catch:{ all -> 0x020e }
            r11 = 1835360622(0x6d65616e, float:4.4368658E27)
            if (r10 != r11) goto L_0x018a
            int r9 = r9 + -12
            java.lang.String r1 = r12.f(r9)     // Catch:{ all -> 0x020e }
            goto L_0x01a5
        L_0x018a:
            r11 = 1851878757(0x6e616d65, float:1.7441594E28)
            if (r10 != r11) goto L_0x0197
            int r9 = r9 + -12
            java.lang.String r2 = r12.f(r9)     // Catch:{ all -> 0x020e }
            goto L_0x01a5
        L_0x0197:
        ...
        L_0x01ab:
            ...
            goto L_0x01a9
        L_0x01b0:
            r12.c(r3)     // Catch:{ all -> 0x020e }
            r3 = 16
            r12.d(r3)     // Catch:{ all -> 0x020e }
            int r4 = r4 + -16
            java.lang.String r3 = r12.f(r4)     // Catch:{ all -> 0x020e }
        ...
        L_0x01c7:
            ...
            int r2 = r12.j()     // Catch:{ all -> 0x020e }
            int r3 = r12.j()     // Catch:{ all -> 0x020e }
            if (r3 == r5) goto L_0x01f9
            java.lang.String r2 = "Failed to parse comment attribute: "
            java.lang.String r1 = defpackage.apu.e(r1)     // Catch:{ all -> 0x020e }
        ...
        L_0x01f9:
            r1 = 8
            r12.d(r1)     // Catch:{ all -> 0x020e }
            int r2 = r2 + -16
            java.lang.String r1 = r12.f(r2)     // Catch:{ all -> 0x020e }
        ...
        L_0x026a:
            ...
            avk r1 = a(r1, r3, r12)     // Catch:{ all -> 0x020e }
            goto L_0x0058
        L_0x0275:
        ...
        L_0x02b3:
            goto L_0x02b2
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.aqj.a(bky):atv");
    }

    private static avk b(int i, String str, bky bky) {
        int j = bky.j();
        if (bky.j() == 1684108385 && j >= 22) {
            bky.d(10);
            int e = bky.e();
            if (e > 0) {
        ...
        String valueOf2 = String.valueOf(apu.e(i));
    ...
    public static aqi a(bky bky, int i, String str) {
        while (true) {
            int i2 = bky.b;
            if (i2 >= i) {
                return null;
    ...
    private static avk a(int i, String str, bky bky) {
        int j = bky.j();
        if (bky.j() == 1684108385) {
            bky.d(8);
            return new avk(str, null, bky.f(j - 16));
        }
        String valueOf = String.valueOf(apu.e(i));
    ...
    private static avc a(int i, String str, bky bky, boolean z, boolean z2) {
        int b = b(bky);
        if (z2) {
            b = Math.min(1, b);
        }

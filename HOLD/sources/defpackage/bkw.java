...
public final class bkw {
    ...
    public static int a(byte[] r8, int r9, int r10, boolean[] r11) {
        ...
        L_0x00c3:
            return r10
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.bkw.a(byte[], int, int, boolean[]):int");
    }
    ...
    public static bku d(byte[] bArr, int i) {
        bkz bkz = new bkz(bArr, 3, i);
        bkz.a(8);
        int e = bkz.e();
        int e2 = bkz.e();
        bkz.a();
        return new bku(e, e2, bkz.b());
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static defpackage.bkv a(byte[] r22, int r23, int r24) {
        /*
            bkz r0 = new bkz
            r1 = r22
            r2 = r23
        ...
        L_0x0192:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.bkw.a(byte[], int, int):bkv");
    }

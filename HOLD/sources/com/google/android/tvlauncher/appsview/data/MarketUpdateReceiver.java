        ...
        if (data != null) {
            ...
            if (!TextUtils.isEmpty(schemeSpecificPart)) {
                ...
                while (true) {
                    ...
                    chn = (chn) it.next();
                    if (chn.c.equalsIgnoreCase(schemeSpecificPart)) {
                        break;
                    }
                }
                boolean z2 = false;
                if (chn != null || intent2.getBooleanExtra("user_initiated", false)) {
                    ...
                    if (chn != null) {
                        ...
                        chn2 = new chn();
                        chn2.b = stringExtra;
                        chn2.c = schemeSpecificPart;
                        chn2.g = booleanExtra;
                        chn2.a = new Intent("android.intent.action.VIEW").setData(new Uri.Builder().scheme("market").authority("details").appendQueryParameter("id", schemeSpecificPart).build()).putExtra("android.intent.extra.REFERRER", new Uri.Builder().scheme("android-app").authority(context.getPackageName()).build());
                        chn2.d = stringExtra2;
                        chn2.e = stringExtra3;
                        chn2.c();
                        z = true;
                    ...
                    if ("com.android.launcher.action.ACTION_PACKAGE_ENQUEUED".equals(action)) {
                        ...
                        chn2.k = intent2.getIntExtra("progress", 0);
                        chn2.m = 5;
                    ...
                    if ("com.android.launcher.action.ACTION_PACKAGE_DEQUEUED".equals(action)) {
                        ...
                        a.d(chn2);
                        ciq ciq = a.n;
                        ciq.a.edit().putBoolean(chn2.c, chn2.g).apply();
                    } else {
                        a.d(chn2);
                    }
                }

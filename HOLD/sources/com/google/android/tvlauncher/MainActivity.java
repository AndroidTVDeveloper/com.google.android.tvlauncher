...
public class MainActivity extends cfc implements cfz {
    private static final ConditionVariable c = new ConditionVariable(false);
    private final daf d = new daf(this);
    private final dbp e = new dbp(this);
    ...
    public final void a(Bundle bundle) {
        if (this.e.a()) {
            ...
            new dbm(new dbl(dbp), new cff(conditionVariable)).execute(dbp.b);
            c.block(4000);
            if (this.d.a()) {
                c();
            }
    ...
    public final void onResume() {
        super.onResume();
        if (!this.d.a()) {
            List<ResolveInfo> queryIntentActivities = this.d.a.getPackageManager().queryIntentActivities(new Intent("android.intent.action.TV_BOOT_COMPLETED"), 0);
            Intent intent = null;
        ...
        Intent a = dlk.a(this, "com.android.tv.action.SHOW_UNSHOWN_NOTIFICATIONS", "android.tvservice.action.SHOW_UNSHOWN_NOTIFICATIONS");
    ...
    public final void onUserInteraction() {
        ...
        if (cqy != null) {
            cqy.b();
            if (cqy.c) {
                cqy.g.sendEmptyMessage(2);
            }
            cqy.g.sendEmptyMessageDelayed(1, (long) cqy.d);
            long currentTimeMillis = System.currentTimeMillis();
            if (currentTimeMillis - cqy.e > 14400000) {
                cfr cfr = cqy.b;
                cfs cfs = new cfs(47);
                cfs.a = true;
                cfr.a(cfs);
                cqy.e = currentTimeMillis;
            }
        }
    }

    /* JADX WARNING: Code restructure failed: missing block: B:26:0x0084, code lost:
        if (defpackage.bwa.b.booleanValue() != false) goto L_0x0086;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:86:0x01c3, code lost:
        if (r0.g != false) goto L_0x01c5;
     */
    ...
    private final void c() {
        /*
            ...
            bwa r2 = defpackage.cyz.a
            android.content.Context r3 = defpackage.bwa.a
            if (r3 == 0) goto L_0x032e
            bvz r3 = r2.c
            java.lang.String r3 = "gms:phenotype:phenotype_flag:debug_bypass_phenotype"
            r4 = 0
            r5 = 0
            boolean r6 = defpackage.bwa.a()     // Catch:{ SecurityException -> 0x0043 }
            if (r6 == 0) goto L_0x0049
            bvw r6 = new bvw     // Catch:{ SecurityException -> 0x0043 }
            r6.<init>(r3)     // Catch:{ SecurityException -> 0x0043 }
            java.lang.Object r3 = defpackage.bwa.a(r6)     // Catch:{ SecurityException -> 0x0043 }
        ...
        L_0x0053:
            ...
            java.lang.Boolean r3 = defpackage.bwa.b
        ...
        L_0x0096:
            ...
            r6 = r2
            bvx r6 = (defpackage.bvx) r6     // Catch:{ ClassCastException -> 0x00ae }
            java.lang.String r6 = r6.d     // Catch:{ ClassCastException -> 0x00ae }
        ...
        L_0x00d2:
            ...
            goto L_0x0166
        L_0x00d7:
            boolean r3 = defpackage.bwa.a()
            if (r3 == 0) goto L_0x0161
            bvv r3 = new bvv     // Catch:{ SecurityException -> 0x0142 }
            r3.<init>(r2)     // Catch:{ SecurityException -> 0x0142 }
            java.lang.Object r3 = defpackage.bwa.a(r3)     // Catch:{ SecurityException -> 0x0142 }
            java.lang.String r3 = (java.lang.String) r3     // Catch:{ SecurityException -> 0x0142 }
            if (r3 == 0) goto L_0x0141
            java.util.regex.Pattern r7 = defpackage.byi.b     // Catch:{ SecurityException -> 0x0142 }
            ...
            java.util.regex.Pattern r7 = defpackage.byi.c     // Catch:{ SecurityException -> 0x0142 }
            java.util.regex.Matcher r7 = r7.matcher(r3)     // Catch:{ SecurityException -> 0x0142 }
            boolean r7 = r7.matches()     // Catch:{ SecurityException -> 0x0142 }
            if (r7 != 0) goto L_0x0133
            r7 = r2
            bvx r7 = (defpackage.bvx) r7     // Catch:{ SecurityException -> 0x0142 }
            java.lang.String r7 = r7.d     // Catch:{ SecurityException -> 0x0142 }
        ...
        L_0x01eb:
            ...
            dck r8 = defpackage.dck.a(r15)
            java.lang.String r8 = r8.j()
            dck r9 = defpackage.dck.a(r15)
            boolean r9 = r9.i()
            dck r10 = defpackage.dck.a(r15)
            dcn r10 = r10.e
            boolean r10 = r10.q
        ...
        L_0x022c:
            ...
            defpackage.del.b = r6
        L_0x0255:
            boolean r2 = defpackage.del.b
            boolean r3 = defpackage.dhz.a(r15)
        ...
        L_0x0337:
            goto L_0x0336
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.tvlauncher.MainActivity.c():void");
    }
}

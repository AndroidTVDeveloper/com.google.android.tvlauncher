...
public class CircularActionButtonView extends ImageView {
    ...
    public final void onFinishInflate() {
        ...
        if (!isInEditMode()) {
            ...
            new dcw(resources.getInteger(R.integer.channel_action_button_focused_animation_duration_ms), resources.getFraction(R.fraction.channel_action_button_focused_scale, 1, 1), resources.getDimension(R.dimen.channel_action_button_focused_elevation)).a(this);
        }

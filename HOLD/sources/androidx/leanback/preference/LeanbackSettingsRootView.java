...
public class LeanbackSettingsRootView extends FrameLayout {
    ...
    public final boolean dispatchKeyEvent(KeyEvent keyEvent) {
        ...
        if ((keyEvent.getAction() != 1 || keyEvent.getKeyCode() != 4 || (onKeyListener = this.a) == null || !onKeyListener.onKey(this, keyEvent.getKeyCode(), keyEvent)) && !super.dispatchKeyEvent(keyEvent)) {
            return false;
        }
        return true;
    }

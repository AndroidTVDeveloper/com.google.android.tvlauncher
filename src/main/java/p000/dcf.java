...
final class dcf {
    ...
    /* renamed from: a */
    public static final Map f8215a = new HashMap();

    /* renamed from: b */
    public static dcf f8216b;

    /* renamed from: b */
    private static boolean m6117b(XmlPullParser xmlPullParser, String str) {
        String attributeValue = xmlPullParser.getAttributeValue(null, str);
        return attributeValue != null && attributeValue.trim().equalsIgnoreCase("true");
    }

    /* renamed from: a */
    private static Uri m6116a(XmlPullParser xmlPullParser, String str) {
        String attributeValue = xmlPullParser.getAttributeValue(null, str);
    ...
    public final p000.dce mo4089a(java.io.InputStream r26) {
        /*
            r25 = this;
        ...
        L_0x00ca:
            ...
            goto L_0x0297
        L_0x00ff:
            r0.f8214c = r4     // Catch:{ IOException -> 0x02a8, XmlPullParserException -> 0x02a6 }
        L_0x0101:
            r24 = r0
            r16 = r6
            goto L_0x0295
        L_0x0107:
            r2 = 2
            dby r4 = r7.f8211a     // Catch:{ IOException -> 0x02a8, XmlPullParserException -> 0x02a6 }
            if (r4 == 0) goto L_0x0122
            java.lang.String r5 = "uri"
            android.net.Uri r5 = m6116a(r3, r5)     // Catch:{ IOException -> 0x02a8, XmlPullParserException -> 0x02a6 }
            if (r5 == 0) goto L_0x011c
            java.lang.String r5 = r5.toString()     // Catch:{ IOException -> 0x02a8, XmlPullParserException -> 0x02a6 }
            r4.mo4082a(r5)     // Catch:{ IOException -> 0x02a8, XmlPullParserException -> 0x02a6 }
            goto L_0x0101
        L_0x011c:
            r24 = r0
            r16 = r6
        ...
        L_0x0128:
            r4 = 2
            java.util.List r5 = r0.f8212a     // Catch:{ IOException -> 0x02a8, XmlPullParserException -> 0x02a6 }
            ...
            android.net.Uri r10 = m6116a(r3, r10)     // Catch:{ IOException -> 0x02a8, XmlPullParserException -> 0x02a6 }
            r16 = r6
            java.lang.String r6 = "data_uri"
            android.net.Uri r6 = m6116a(r3, r6)     // Catch:{ IOException -> 0x02a8, XmlPullParserException -> 0x02a6 }
            r18 = r1
            java.lang.String r1 = "is_game"
            boolean r1 = m6117b(r3, r1)     // Catch:{ IOException -> 0x028d, XmlPullParserException -> 0x028b }
            r19 = r2
            java.lang.String r2 = "is_virtual_app"
            boolean r2 = m6117b(r3, r2)     // Catch:{ IOException -> 0x028d, XmlPullParserException -> 0x028b }
            r20 = r8
        ...
        L_0x0186:
            ...
            java.util.Map r13 = p000.dcf.f8215a     // Catch:{ IOException -> 0x028d, XmlPullParserException -> 0x028b }
        ...
        L_0x0196:
            ...
            r9.f8173a = r5     // Catch:{ IOException -> 0x028d, XmlPullParserException -> 0x028b }
            r9.f8174b = r4     // Catch:{ IOException -> 0x028d, XmlPullParserException -> 0x028b }
            java.lang.String r4 = r10.toString()     // Catch:{ IOException -> 0x028d, XmlPullParserException -> 0x028b }
            r9.f8175c = r4     // Catch:{ IOException -> 0x028d, XmlPullParserException -> 0x028b }
        ...
        L_0x01ad:
            r4 = 0
        L_0x01af:
            r9.f8176d = r4     // Catch:{ IOException -> 0x028d, XmlPullParserException -> 0x028b }
            r9.f8177e = r8     // Catch:{ IOException -> 0x028d, XmlPullParserException -> 0x028b }
            java.util.Map r4 = p000.dcf.f8215a     // Catch:{ IOException -> 0x028d, XmlPullParserException -> 0x028b }
            ...
            r9.f8178f = r4     // Catch:{ IOException -> 0x028d, XmlPullParserException -> 0x028b }
            r9.f8179g = r14     // Catch:{ IOException -> 0x028d, XmlPullParserException -> 0x028b }
            r9.f8180h = r1     // Catch:{ IOException -> 0x028d, XmlPullParserException -> 0x028b }
            r9.f8181i = r2     // Catch:{ IOException -> 0x028d, XmlPullParserException -> 0x028b }
            dby r1 = r9.mo4080a()     // Catch:{ IOException -> 0x028d, XmlPullParserException -> 0x028b }
            java.util.HashSet r2 = r0.f8213b     // Catch:{ IOException -> 0x028d, XmlPullParserException -> 0x028b }
            boolean r2 = r2.contains(r1)     // Catch:{ IOException -> 0x028d, XmlPullParserException -> 0x028b }
            if (r2 != 0) goto L_0x01d9
            java.util.List r2 = r0.f8212a     // Catch:{ IOException -> 0x028d, XmlPullParserException -> 0x028b }
            r2.add(r1)     // Catch:{ IOException -> 0x028d, XmlPullParserException -> 0x028b }
            java.util.HashSet r2 = r0.f8213b     // Catch:{ IOException -> 0x028d, XmlPullParserException -> 0x028b }
            r2.add(r1)     // Catch:{ IOException -> 0x028d, XmlPullParserException -> 0x028b }
        L_0x01d9:
            r7.f8211a = r1     // Catch:{ IOException -> 0x028d, XmlPullParserException -> 0x028b }
            r24 = r0
            r1 = r18
            goto L_0x0295
        L_0x01e1:
        ...
        L_0x01e6:
            ...
            r2 = 0
            r7.f8211a = r2     // Catch:{ IOException -> 0x02a8, XmlPullParserException -> 0x02a6 }
            goto L_0x0295
        L_0x028b:
            r0 = move-exception
            goto L_0x028e
        ...
        L_0x02a9:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.dcf.mo4089a(java.io.InputStream):dce");
    }
}

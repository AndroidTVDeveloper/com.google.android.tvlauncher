...
/* renamed from: cd */
/* compiled from: PG */
public final class C0059cd {

    /* renamed from: a */
    public static final C0075cs f5297a = new C0075cs(16);

    /* renamed from: b */
    public static final Object f5298b = new Object();

    /* renamed from: c */
    public static final C0087dd f5299c = new C0087dd();

    /* renamed from: d */
    private static final C0065cj f5300d = new C0065cj("fonts");

    /* renamed from: e */
    private static final Comparator f5301e = new C0054bz();

    /* JADX WARNING: Removed duplicated region for block: B:71:0x019e A[Catch:{ NameNotFoundException -> 0x0218 }] */
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    static p000.C0058cc m4556a(android.content.Context r24, p000.C0050bv r25, int r26) {
        /*
            r0 = r25
            ...
            java.lang.String r12 = r0.f4892a     // Catch:{ NameNotFoundException -> 0x0218 }
            r13 = 0
            ...
            java.lang.String r8 = r0.f4893b     // Catch:{ NameNotFoundException -> 0x0218 }
        ...
        L_0x003b:
            ...
            java.util.Comparator r8 = p000.C0059cd.f5301e     // Catch:{ NameNotFoundException -> 0x0218 }
            java.util.Collections.sort(r10, r8)     // Catch:{ NameNotFoundException -> 0x0218 }
            java.util.List r8 = r0.f4895d     // Catch:{ NameNotFoundException -> 0x0218 }
            if (r8 != 0) goto L_0x004b
            java.util.List r8 = p000.C0122el.m7246a(r11, r13)     // Catch:{ NameNotFoundException -> 0x0218 }
        L_0x004b:
            r11 = 0
        L_0x004c:
            ...
            java.util.Comparator r15 = p000.C0059cd.f5301e     // Catch:{ NameNotFoundException -> 0x0218 }
        ...
        L_0x0093:
            ...
            java.lang.String r0 = r0.f4894c     // Catch:{ all -> 0x019a }
            r12 = 0
        ...
        L_0x018a:
            r0 = 0
            cb[] r1 = new p000.C0057cb[r0]     // Catch:{ NameNotFoundException -> 0x0218 }
            java.lang.Object[] r0 = r9.toArray(r1)     // Catch:{ NameNotFoundException -> 0x0218 }
            cb[] r0 = (p000.C0057cb[]) r0     // Catch:{ NameNotFoundException -> 0x0218 }
        ...
        L_0x01a9:
            ...
            cb[] r0 = r1.f5097b
            bp r1 = p000.C0036bh.f3914a
            r13 = r24
            r15 = r26
            android.graphics.Typeface r0 = r1.mo1963a(r13, r0, r15)
        ...
        L_0x01e0:
            ...
            r2.append(r3)     // Catch:{ NameNotFoundException -> 0x0218 }
            java.lang.String r0 = r0.f4893b     // Catch:{ NameNotFoundException -> 0x0218 }
        ...
        L_0x0218:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.C0059cd.m4556a(android.content.Context, bv, int):cc");
    }

    /* renamed from: a */
    public static Typeface m4555a(Context context, C0050bv bvVar, C0031bc bcVar, boolean z, int i, int i2) {
        ReentrantLock reentrantLock;
        Object obj;
        String str = bvVar.f4896e + "-" + i2;
        Typeface typeface = (Typeface) f5297a.mo3692a(str);
        if (typeface != null) {
            bcVar.mo1751a(typeface);
            return typeface;
        } else if (z && i == -1) {
            C0058cc a = m4556a(context, bvVar, i2);
            if (a.f5235b == 0) {
                bcVar.mo1752b(a.f5234a);
            } else {
                C0031bc.m2781a();
            }
            return a.f5234a;
        } else {
            C0051bw bwVar = new C0051bw(context, bvVar, i2, str);
            if (!z) {
                C0052bx bxVar = new C0052bx(bcVar);
                synchronized (f5298b) {
                    ArrayList arrayList = (ArrayList) f5299c.get(str);
                    if (arrayList == null) {
                        ArrayList arrayList2 = new ArrayList();
                        arrayList2.add(bxVar);
                        f5299c.put(str, arrayList2);
                        f5300d.mo2881a(new C0062cg(bwVar, new Handler(), new C0053by(str)));
                        return null;
                    }
                    arrayList.add(bxVar);
                    return null;
            ...
            try {
                C0065cj cjVar = f5300d;
                reentrantLock = new ReentrantLock();
                Condition newCondition = reentrantLock.newCondition();
                AtomicReference atomicReference = new AtomicReference();
                AtomicBoolean atomicBoolean = new AtomicBoolean(true);
                cjVar.mo2881a(new C0063ch(atomicReference, bwVar, reentrantLock, atomicBoolean, newCondition));
                reentrantLock.lock();
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static java.util.Map m4557a(android.content.Context r14, p000.C0057cb[] r15) {
        /*
        ...
        L_0x004d:
            r6 = move-exception
            p000.dhr.m6455a(r7, r6)     // Catch:{ all -> 0x0052 }
        L_0x0051:
        ...
        L_0x0059:
            r4 = move-exception
            p000.dhr.m6455a(r6, r4)     // Catch:{ IOException -> 0x0060 }
        L_0x005d:
        ...
        L_0x0068:
            ...
            return r14
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.C0059cd.m4557a(android.content.Context, cb[]):java.util.Map");
    }
}

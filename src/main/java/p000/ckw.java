...
public final class ckw extends AsyncTask {
    ...
    /* renamed from: a */
    private final /* synthetic */ long f5842a;

    /* renamed from: b */
    private final /* synthetic */ String f5843b;

    /* renamed from: c */
    private final /* synthetic */ cla f5844c;
    ...
    public final /* bridge */ /* synthetic */ Object doInBackground(Object[] objArr) {
        ...
        cla cla = this.f5844c;
        int i = cla.f5856x;
        ContentResolver contentResolver = cla.f5873a.getContentResolver();
        String str7 = "poster_art_uri";
        String str8 = "content_rating";
        Cursor query = contentResolver.query(TvContract.buildPreviewProgramUri(this.f5842a), null, null, null, null);
        boolean z2 = false;
        if (query != null) {
            try {
        ...
        if (z2) {
            ...
            contentValues.put("package_name", this.f5843b);
            ...
            ((TvInputManager) this.f5844c.f5873a.getSystemService("tv_input")).notifyPreviewProgramAddedToWatchNext(this.f5843b, this.f5842a, ContentUris.parseId(this.f5844c.f5873a.getContentResolver().insert(TvContract.WatchNextPrograms.CONTENT_URI, contentValues)));
        } else {
            z = z2;
        }

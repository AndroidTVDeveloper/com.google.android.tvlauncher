...
public final class bck implements biz {
    ...
    /* renamed from: A */
    private static final Pattern f3280A = Pattern.compile("NAME=\"(.+?)\"");

    /* renamed from: B */
    private static final Pattern f3281B = Pattern.compile("GROUP-ID=\"(.+?)\"");

    /* renamed from: C */
    private static final Pattern f3282C = Pattern.compile("CHARACTERISTICS=\"(.+?)\"");

    /* renamed from: D */
    private static final Pattern f3283D = Pattern.compile("INSTREAM-ID=\"((?:CC|SERVICE)\\d+)\"");

    /* renamed from: E */
    private static final Pattern f3284E = m2813b("AUTOSELECT");

    /* renamed from: F */
    private static final Pattern f3285F = m2813b("DEFAULT");

    /* renamed from: G */
    private static final Pattern f3286G = m2813b("FORCED");

    /* renamed from: H */
    private static final Pattern f3287H = Pattern.compile("VALUE=\"(.+?)\"");

    /* renamed from: I */
    private static final Pattern f3288I = Pattern.compile("IMPORT=\"(.+?)\"");

    /* renamed from: J */
    private static final Pattern f3289J = Pattern.compile("\\{\\$([a-zA-Z0-9\\-_]+)\\}");

    /* renamed from: a */
    private static final Pattern f3290a = Pattern.compile("AVERAGE-BANDWIDTH=(\\d+)\\b");

    /* renamed from: b */
    private static final Pattern f3291b = Pattern.compile("VIDEO=\"(.+?)\"");

    /* renamed from: c */
    private static final Pattern f3292c = Pattern.compile("AUDIO=\"(.+?)\"");

    /* renamed from: d */
    private static final Pattern f3293d = Pattern.compile("SUBTITLES=\"(.+?)\"");

    /* renamed from: e */
    private static final Pattern f3294e = Pattern.compile("CLOSED-CAPTIONS=\"(.+?)\"");

    /* renamed from: f */
    private static final Pattern f3295f = Pattern.compile("[^-]BANDWIDTH=(\\d+)\\b");

    /* renamed from: g */
    private static final Pattern f3296g = Pattern.compile("CHANNELS=\"(.+?)\"");

    /* renamed from: h */
    private static final Pattern f3297h = Pattern.compile("CODECS=\"(.+?)\"");

    /* renamed from: i */
    private static final Pattern f3298i = Pattern.compile("RESOLUTION=(\\d+x\\d+)");

    /* renamed from: j */
    private static final Pattern f3299j = Pattern.compile("FRAME-RATE=([\\d\\.]+)\\b");

    /* renamed from: k */
    private static final Pattern f3300k = Pattern.compile("#EXT-X-TARGETDURATION:(\\d+)\\b");

    /* renamed from: l */
    private static final Pattern f3301l = Pattern.compile("#EXT-X-VERSION:(\\d+)\\b");

    /* renamed from: m */
    private static final Pattern f3302m = Pattern.compile("#EXT-X-PLAYLIST-TYPE:(.+)\\b");

    /* renamed from: n */
    private static final Pattern f3303n = Pattern.compile("#EXT-X-MEDIA-SEQUENCE:(\\d+)\\b");

    /* renamed from: o */
    private static final Pattern f3304o = Pattern.compile("#EXTINF:([\\d\\.]+)\\b");

    /* renamed from: p */
    private static final Pattern f3305p = Pattern.compile("#EXTINF:[\\d\\.]+\\b,(.+)");

    /* renamed from: q */
    private static final Pattern f3306q = Pattern.compile("TIME-OFFSET=(-?[\\d\\.]+)\\b");

    /* renamed from: r */
    private static final Pattern f3307r = Pattern.compile("#EXT-X-BYTERANGE:(\\d+(?:@\\d+)?)\\b");

    /* renamed from: s */
    private static final Pattern f3308s = Pattern.compile("BYTERANGE=\"(\\d+(?:@\\d+)?)\\b\"");

    /* renamed from: t */
    private static final Pattern f3309t = Pattern.compile("METHOD=(NONE|AES-128|SAMPLE-AES|SAMPLE-AES-CENC|SAMPLE-AES-CTR)\\s*(?:,|$)");

    /* renamed from: u */
    private static final Pattern f3310u = Pattern.compile("KEYFORMAT=\"(.+?)\"");

    /* renamed from: v */
    private static final Pattern f3311v = Pattern.compile("KEYFORMATVERSIONS=\"(.+?)\"");

    /* renamed from: w */
    private static final Pattern f3312w = Pattern.compile("URI=\"(.+?)\"");

    /* renamed from: x */
    private static final Pattern f3313x = Pattern.compile("IV=([^,.*]+)");

    /* renamed from: y */
    private static final Pattern f3314y = Pattern.compile("TYPE=(AUDIO|VIDEO|SUBTITLES|CLOSED-CAPTIONS)");

    /* renamed from: z */
    private static final Pattern f3315z = Pattern.compile("LANGUAGE=\"(.+?)\"");

    /* renamed from: K */
    private final bcf f3316K;
    ...
    /* renamed from: b */
    private static Pattern m2813b(String str) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:103:0x0263, code lost:
        r22 = r0;
        r18 = m2810a(r14, p000.bck.f3312w, r3);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:114:0x02a5, code lost:
        r0 = m2810a(r14, p000.bck.f3307r, r3).split("@");
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:146:0x034e, code lost:
        r68 = r0;
        r73 = r1;
        r0 = (p000.anp[]) r1.values().toArray(new p000.anp[0]);
        r1 = new p000.anq(r7, r0);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:153:0x038a, code lost:
        r5 = r0[r1];
        r10[r1] = new p000.anp(r5.f1445a, r5.f1446b, r5.f1447c, null);
        r1 = r1 + 1;
        r0 = r0;
        r5 = r74;
        r6 = r6;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:155:0x03bd, code lost:
        r4 = r79;
        r4.add(new p000.bcg(m2808a(r14, r3), r65, r66, r62, r63, r1, r18, r4, r42, r60, r59));
        r63 = r63 + r66;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:166:0x046e, code lost:
        r27 = p000.aja.m633b(p000.blm.m3679f(r14.substring(r14.indexOf(58) + 1))) - r63;
        r79 = r4;
        r14 = r68;
        r10 = r69;
        r0 = r70;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:168:0x049f, code lost:
        m2809a(r14, p000.bck.f3305p, "", r3);
        r66 = (long) (m2811b(r14, p000.bck.f3304o) * 1000000.0d);
        r79 = r79;
        r14 = r68;
        r10 = r69;
        r0 = r0;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:169:0x04d6, code lost:
        ...
        r76 = r7;
        r77 = r8;
        r0 = m2812b(r14, p000.bck.f3288I, r3);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:171:0x04ec, code lost:
        r3.put(m2810a(r14, p000.bck.f3280A, r3), m2810a(r14, p000.bck.f3287H, r3));
        r1 = r19;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:172:0x04fe, code lost:
        r1 = r19;
        r5 = (java.lang.String) r1.f3249h.get(r0);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:176:0x0525, code lost:
        r36 = ((long) m2805a(r14, p000.bck.f3300k)) * 1000000;
        r19 = r19;
        r79 = r79;
        r14 = r68;
        r10 = r69;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:177:0x055a, code lost:
        r19 = r19;
        r79 = r79;
        r29 = (long) (m2811b(r14, p000.bck.f3306q) * 1000000.0d);
        r14 = r68;
        r10 = r10;
        r0 = r0;
        r1 = r1;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:182:0x059d, code lost:
        r18 = new p000.bch(r21, r20, r2, r29, r27, r31, r32, r33, r35, r36, r39, r40, r16, r41, r4);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:183:0x05be, code lost:
        p000.blm.m3645a((java.io.Closeable) r38);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:18:0x005d, code lost:
        if (p000.blm.m3648a(m2804a(r2, false, r7)) == false) goto L_0x0bb9;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:191:0x0610, code lost:
        if (r0.mo1762a() != false) goto L_0x0965;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:204:0x063d, code lost:
        ...
        r30 = r13;
        r20 = r14;
        r0.add(new p000.bce(r11.f3236a, r11.f3237b.mo425a(new p000.atw(new p000.bbw(null, null, (java.util.List) p000.bks.m3507a((java.util.ArrayList) r4.get(r11.f3236a))))), r11.f3238c, r11.f3239d, r11.f3240e, r11.f3241f));
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:210:0x06b4, code lost:
        ...
        r9 = m2810a(r4, p000.bck.f3281B, r5);
        r11 = m2810a(r4, p000.bck.f3280A, r5);
        r13 = m2812b(r4, p000.bck.f3312w, r5);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:214:0x06d5, code lost:
        r50 = m2812b(r4, p000.bck.f3315z, r5);
        r14 = m2814c(r4, p000.bck.f3285F);
        r79 = r12;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:215:0x06e9, code lost:
        if (m2814c(r4, p000.bck.f3286G) != false) goto L_0x06ec;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:219:0x06f4, code lost:
        if (m2814c(r4, p000.bck.f3284E) != false) goto L_0x06f9;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:222:0x06fe, code lost:
        r12 = m2812b(r4, p000.bck.f3282C, r5);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:224:0x070a, code lost:
        r12 = p000.blm.m3658a(r12, ",");
     */
    /* JADX WARNING: Code restructure failed: missing block: B:225:0x0716, code lost:
        if (p000.blm.m3653a((java.lang.Object[]) r12, (java.lang.Object) "public.accessibility.describes-video") != false) goto L_0x071a;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:229:0x0725, code lost:
        if (p000.blm.m3653a((java.lang.Object[]) r12, (java.lang.Object) "public.accessibility.transcribes-spoken-dialog") == false) goto L_0x0729;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:232:0x072f, code lost:
        if (p000.blm.m3653a((java.lang.Object[]) r12, (java.lang.Object) "public.accessibility.describes-music-and-sound") == false) goto L_0x0734;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:235:0x073a, code lost:
        if (p000.blm.m3653a((java.lang.Object[]) r12, (java.lang.Object) "public.easy-to-read") == false) goto L_0x0743;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:238:0x0743, code lost:
        ...
        r22 = r3;
        r23 = r15;
        r0 = new p000.atw(new p000.bbw(r9, r11, java.util.Collections.emptyList()));
        r3 = m2810a(r4, p000.bck.f3314y, r5);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:262:?, code lost:
        r0 = m2810a(r4, p000.bck.f3283D, r5);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:268:0x07fd, code lost:
        r2.add(p000.akh.m741a(r39, r11, null, r42, null, -1, r49, r14, r50, r48));
     */
    /* JADX WARNING: Code restructure failed: missing block: B:269:0x0816, code lost:
        r10.add(new p000.bcd(r13, p000.akh.m738a(r39, r11, "application/x-mpegURL", "text/vtt", -1, r49, r14, r50).mo425a(r0), r11));
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:278:0x0857, code lost:
        r43 = p000.blm.m3637a(r15.f3237b.f553f, 1);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:283:0x086f, code lost:
        r4 = m2812b(r4, p000.bck.f3296g, r5);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:285:0x0877, code lost:
        r9 = java.lang.Integer.parseInt(p000.blm.m3670b(r4, "/")[0]);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:292:0x089f, code lost:
        r3 = p000.akh.m742a(r39, r11, "application/x-mpegURL", r42, r43, -1, r45, -1, (java.util.List) null, r49, r14, r50);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:294:0x08b3, code lost:
        r8.add(new p000.bcd(r13, r3.mo425a(r0), r11));
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:310:0x0914, code lost:
        r0 = p000.akh.m739a(r39, r11, "application/x-mpegURL", r42, r43, -1, r45, r46, r47, (java.util.List) null, r49, r14).mo425a(r0);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:312:0x0928, code lost:
        r7.add(new p000.bcd(r13, r0, r11));
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:318:0x0951, code lost:
        r18 = new p000.bcf(r22, r20, r21, r7, r8, r10, r25, r26, r27, r28, r5, r30);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:326:0x098f, code lost:
        r5.put(m2810a(r2, p000.bck.f3280A, r5), m2810a(r2, p000.bck.f3287H, r5));
        r13 = r79;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:336:0x09d6, code lost:
        r14 = m2806a(r2, m2809a(r2, p000.bck.f3310u, "identity", r5), r5);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:338:0x09e2, code lost:
        r69 = r3;
        r3 = r30;
        r3.add(new p000.anq(m2807a(m2810a(r2, p000.bck.f3309t, r5)), r14));
        r24 = r0;
        r20 = r1;
        r19 = r3;
        r21 = r4;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:342:0x0a2f, code lost:
        ...
        r12 = m2805a(r2, p000.bck.f3295f);
        r14 = m2812b(r2, p000.bck.f3290a, r5);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:346:0x0a4a, code lost:
        r43 = m2812b(r2, p000.bck.f3297h, r5);
        r14 = m2812b(r2, p000.bck.f3298i, r5);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:355:0x0a87, code lost:
        r1 = m2812b(r2, p000.bck.f3299j, r5);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:359:0x0a9a, code lost:
        r1 = m2812b(r2, p000.bck.f3291b, r5);
        r14 = m2812b(r2, p000.bck.f3292c, r5);
        r19 = r3;
        r3 = m2812b(r2, p000.bck.f3293d, r5);
        r21 = r4;
        r2 = m2812b(r2, p000.bck.f3294e, r5);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:360:0x0aba, code lost:
        if (r0.mo1762a() == false) goto L_0x0b45;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:361:0x0abc, code lost:
        r24 = r0;
        r0 = r22;
        r4 = p000.blk.m3616a(r0, m2808a(r0.mo1763b(), r5));
        r22 = r0;
        r6.add(new p000.bce(r4, p000.akh.m739a(java.lang.Integer.toString(r6.size()), (java.lang.String) null, "application/x-mpegURL", (java.lang.String) null, r43, r12, r45, r46, r47, (java.util.List) null, 0, 0), r1, r14, r3, r2));
        r0 = r18;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:365:0x0b15, code lost:
        r5.add(new p000.bbv((long) r12, r1, r14, r3, r2));
        r5 = r79;
        r4 = r0;
        r12 = r13;
        r6 = r6;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:367:0x0b4c, code lost:
        throw new p000.ako("#EXT-X-STREAM-INF tag must be followed by another line");
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:372:0x0bac, code lost:
        p000.blm.m3645a((java.io.Closeable) r2);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:373:0x0bb8, code lost:
        throw new p000.ako("Failed to parse the playlist, could not identify any tags.");
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:51:0x0128, code lost:
        if (r4.mo1762a() == false) goto L_0x058f;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:58:0x0144, code lost:
        r4 = m2810a(r14, p000.bck.f3302m, r3);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:69:0x0191, code lost:
        r45 = m2810a(r14, p000.bck.f3312w, r3);
        r4 = m2812b(r14, p000.bck.f3308s, r3);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:79:0x01c4, code lost:
        r44 = new p000.bcg(r45, r46, r48, r18, r22);
        r4 = r80;
        r60 = -1;
        r42 = 0;
        r14 = r68;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:81:0x01e3, code lost:
        throw new p000.ako("The encryption IV attribute must be present when an initialization segment is encrypted with METHOD=AES-128.");
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:86:0x01f2, code lost:
        r53 = java.lang.Long.parseLong(m2810a(r14, p000.bck.f3303n, java.util.Collections.emptyMap()));
        r4 = r80;
        r33 = r53;
        r14 = r68;
        r10 = r69;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:89:0x0213, code lost:
        r35 = m2805a(r14, p000.bck.f3301l);
        r4 = r80;
        r14 = r68;
        r10 = r69;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:96:0x0234, code lost:
        r4 = m2810a(r14, p000.bck.f3309t, r3);
        r10 = m2809a(r14, p000.bck.f3310u, "identity", r3);
        r70 = r0;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:98:0x024a, code lost:
        r0 = m2812b(r14, p000.bck.f3313x, r3);
     */
    ...
    public final /* bridge */ /* synthetic */ java.lang.Object mo1648a(android.net.Uri r79, java.io.InputStream r80) {
        /*
            r78 = this;
        ...
        L_0x0036:
            r5 = 1
            int r4 = m2804a(r2, r5, r4)     // Catch:{ all -> 0x0bc5 }
            r6 = 0
            r7 = r4
            r4 = 0
        L_0x003e:
        ...
        L_0x0050:
            ...
            goto L_0x0bbb
        L_0x0054:
            int r4 = m2804a(r2, r6, r7)     // Catch:{ all -> 0x0bc5 }
            boolean r4 = p000.blm.m3648a(r4)     // Catch:{ all -> 0x0bc5 }
        ...
        L_0x00c0:
            ...
            r65 = 0
        L_0x0124:
            boolean r44 = r4.mo1762a()     // Catch:{ all -> 0x0bc3 }
            if (r44 == 0) goto L_0x058f
            r68 = r14
            java.lang.String r14 = r4.mo1763b()     // Catch:{ all -> 0x0bc3 }
        ...
        L_0x013a:
            ...
            java.util.regex.Pattern r4 = p000.bck.f3302m     // Catch:{ all -> 0x0bc3 }
            java.lang.String r4 = m2810a(r14, r4, r3)     // Catch:{ all -> 0x0bc3 }
        ...
        L_0x017c:
            ...
            java.util.regex.Pattern r4 = p000.bck.f3312w     // Catch:{ all -> 0x0bc3 }
            java.lang.String r45 = m2810a(r14, r4, r3)     // Catch:{ all -> 0x0bc3 }
            java.util.regex.Pattern r4 = p000.bck.f3308s     // Catch:{ all -> 0x0bc3 }
            java.lang.String r4 = m2812b(r14, r4, r3)     // Catch:{ all -> 0x0bc3 }
        ...
        L_0x01e4:
            ...
            java.util.regex.Pattern r4 = p000.bck.f3303n     // Catch:{ all -> 0x0bc3 }
            java.util.Map r10 = java.util.Collections.emptyMap()     // Catch:{ all -> 0x0bc3 }
            java.lang.String r4 = m2810a(r14, r4, r10)     // Catch:{ all -> 0x0bc3 }
        ...
        L_0x020b:
            ...
            java.util.regex.Pattern r4 = p000.bck.f3301l     // Catch:{ all -> 0x0bc3 }
            int r35 = m2805a(r14, r4)     // Catch:{ all -> 0x0bc3 }
            r4 = r80
            r14 = r68
            r10 = r69
            goto L_0x0124
        L_0x0221:
            ...
            java.util.regex.Pattern r4 = p000.bck.f3309t     // Catch:{ all -> 0x0bc3 }
            java.lang.String r4 = m2810a(r14, r4, r3)     // Catch:{ all -> 0x0bc3 }
            java.util.regex.Pattern r10 = p000.bck.f3310u     // Catch:{ all -> 0x0bc3 }
            java.lang.String r10 = m2809a(r14, r10, r11, r3)     // Catch:{ all -> 0x0bc3 }
            r70 = r0
            java.lang.String r0 = "NONE"
            boolean r0 = r0.equals(r4)     // Catch:{ all -> 0x0bc3 }
            if (r0 != 0) goto L_0x0288
            java.util.regex.Pattern r0 = p000.bck.f3313x     // Catch:{ all -> 0x0bc3 }
            java.lang.String r0 = m2812b(r14, r0, r3)     // Catch:{ all -> 0x0bc3 }
        ...
        L_0x026f:
            ...
            java.lang.String r7 = m2807a(r4)     // Catch:{ all -> 0x0bc3 }
        L_0x0275:
            anp r4 = m2806a(r14, r10, r3)     // Catch:{ all -> 0x0bc3 }
        ...
        L_0x029d:
            ...
            java.util.regex.Pattern r0 = p000.bck.f3307r     // Catch:{ all -> 0x0bc3 }
            java.lang.String r0 = m2810a(r14, r0, r3)     // Catch:{ all -> 0x0bc3 }
            java.lang.String r4 = "@"
        ...
        L_0x0346:
            ...
            r73 = r1
            r0 = 0
            anp[] r1 = new p000.anp[r0]     // Catch:{ all -> 0x0bc3 }
            java.lang.Object[] r0 = r10.toArray(r1)     // Catch:{ all -> 0x0bc3 }
            anp[] r0 = (p000.anp[]) r0     // Catch:{ all -> 0x0bc3 }
        ...
        L_0x036f:
            ...
            anp[] r10 = new p000.anp[r10]     // Catch:{ all -> 0x0bc3 }
            r44 = r1
            r1 = 0
        L_0x0375:
            r74 = r5
        ...
        L_0x038a:
            ...
            r75 = r6
            java.util.UUID r6 = r5.f1445a     // Catch:{ all -> 0x0bc3 }
            r76 = r7
            java.lang.String r7 = r5.f1446b     // Catch:{ all -> 0x0bc3 }
            java.lang.String r5 = r5.f1447c     // Catch:{ all -> 0x0bc3 }
            r77 = r8
            r8 = 0
        ...
        L_0x03bd:
            ...
            java.lang.String r45 = m2808a(r14, r3)     // Catch:{ all -> 0x0bc3 }
            r44 = r0
            r46 = r65
            r47 = r66
            r49 = r62
        ...
        L_0x045e:
            ...
            int r0 = r0 + r1
            java.lang.String r0 = r14.substring(r0)     // Catch:{ all -> 0x0bc3 }
            long r0 = p000.blm.m3679f(r0)     // Catch:{ all -> 0x0bc3 }
            long r0 = p000.aja.m633b(r0)     // Catch:{ all -> 0x0bc3 }
            long r27 = r0 - r63
            r79 = r4
            r14 = r68
            r10 = r69
        ...
        L_0x049f:
            ...
            r76 = r7
            r77 = r8
            java.util.regex.Pattern r0 = p000.bck.f3304o     // Catch:{ all -> 0x0bc3 }
            double r0 = m2811b(r14, r0)     // Catch:{ all -> 0x0bc3 }
            double r0 = r0 * r44
            long r0 = (long) r0     // Catch:{ all -> 0x0bc3 }
            java.util.regex.Pattern r5 = p000.bck.f3305p     // Catch:{ all -> 0x0bc3 }
            java.lang.String r6 = ""
            m2809a(r14, r5, r6, r3)     // Catch:{ all -> 0x0bc3 }
            r66 = r0
            r79 = r4
            r14 = r68
            r10 = r69
        ...
        L_0x04d6:
            ...
            r76 = r7
            r77 = r8
            java.util.regex.Pattern r0 = p000.bck.f3288I     // Catch:{ all -> 0x0bc3 }
            java.lang.String r0 = m2812b(r14, r0, r3)     // Catch:{ all -> 0x0bc3 }
            if (r0 != 0) goto L_0x04fe
            java.util.regex.Pattern r0 = p000.bck.f3280A     // Catch:{ all -> 0x0bc3 }
            java.lang.String r0 = m2810a(r14, r0, r3)     // Catch:{ all -> 0x0bc3 }
            java.util.regex.Pattern r1 = p000.bck.f3287H     // Catch:{ all -> 0x0bc3 }
            java.lang.String r1 = m2810a(r14, r1, r3)     // Catch:{ all -> 0x0bc3 }
            r3.put(r0, r1)     // Catch:{ all -> 0x0bc3 }
            r1 = r19
            goto L_0x050d
        L_0x04fe:
            r1 = r19
            java.util.Map r5 = r1.f3249h     // Catch:{ all -> 0x0bc3 }
        ...
        L_0x0525:
            ...
            r77 = r8
            r1 = r19
            java.util.regex.Pattern r0 = p000.bck.f3300k     // Catch:{ all -> 0x0bc3 }
            int r0 = m2805a(r14, r0)     // Catch:{ all -> 0x0bc3 }
        ...
        L_0x055a:
            ...
            r69 = r10
            r1 = r19
            java.util.regex.Pattern r0 = p000.bck.f3306q     // Catch:{ all -> 0x0bc3 }
            double r5 = m2811b(r14, r0)     // Catch:{ all -> 0x0bc3 }
            double r5 = r5 * r44
        ...
        L_0x05c3:
            ...
            r28 = 0
        L_0x060a:
            boolean r18 = r0.mo1762a()     // Catch:{ all -> 0x0bc5 }
            r19 = -1
        ...
        L_0x061d:
            ...
            bce r11 = (p000.bce) r11     // Catch:{ all -> 0x0bc5 }
            r38 = r2
            android.net.Uri r2 = r11.f3236a     // Catch:{ all -> 0x0bc3 }
            boolean r2 = r1.add(r2)     // Catch:{ all -> 0x0bc3 }
            if (r2 == 0) goto L_0x068c
            akh r2 = r11.f3237b     // Catch:{ all -> 0x0bc3 }
            atw r2 = r2.f554g     // Catch:{ all -> 0x0bc3 }
        ...
        L_0x063b:
            r2 = 0
        L_0x063d:
            p000.bks.m3512b(r2)     // Catch:{ all -> 0x0bc3 }
            bbw r2 = new bbw     // Catch:{ all -> 0x0bc3 }
            r79 = r1
            android.net.Uri r1 = r11.f3236a     // Catch:{ all -> 0x0bc3 }
            java.lang.Object r1 = r4.get(r1)     // Catch:{ all -> 0x0bc3 }
            java.util.ArrayList r1 = (java.util.ArrayList) r1     // Catch:{ all -> 0x0bc3 }
            java.lang.Object r1 = p000.bks.m3507a(r1)     // Catch:{ all -> 0x0bc3 }
            java.util.List r1 = (java.util.List) r1     // Catch:{ all -> 0x0bc3 }
            r18 = r4
            r4 = 0
            r2.<init>(r4, r4, r1)     // Catch:{ all -> 0x0bc3 }
            akh r1 = r11.f3237b     // Catch:{ all -> 0x0bc3 }
            atw r4 = new atw     // Catch:{ all -> 0x0bc3 }
            r30 = r13
            r20 = r14
            r13 = 1
            atv[] r14 = new p000.atv[r13]     // Catch:{ all -> 0x0bc3 }
            r13 = 0
            r14[r13] = r2     // Catch:{ all -> 0x0bc3 }
            r4.<init>(r14)     // Catch:{ all -> 0x0bc3 }
            akh r33 = r1.mo425a(r4)     // Catch:{ all -> 0x0bc3 }
            bce r1 = new bce     // Catch:{ all -> 0x0bc3 }
            android.net.Uri r2 = r11.f3236a     // Catch:{ all -> 0x0bc3 }
            java.lang.String r4 = r11.f3238c     // Catch:{ all -> 0x0bc3 }
            java.lang.String r13 = r11.f3239d     // Catch:{ all -> 0x0bc3 }
            java.lang.String r14 = r11.f3240e     // Catch:{ all -> 0x0bc3 }
            java.lang.String r11 = r11.f3241f     // Catch:{ all -> 0x0bc3 }
            r31 = r1
            r32 = r2
            r34 = r4
            r35 = r13
        ...
        L_0x06ae:
            ...
            java.util.regex.Pattern r9 = p000.bck.f3281B     // Catch:{ all -> 0x0bc3 }
            java.lang.String r9 = m2810a(r4, r9, r5)     // Catch:{ all -> 0x0bc3 }
            java.util.regex.Pattern r11 = p000.bck.f3280A     // Catch:{ all -> 0x0bc3 }
            java.lang.String r11 = m2810a(r4, r11, r5)     // Catch:{ all -> 0x0bc3 }
            java.util.regex.Pattern r13 = p000.bck.f3312w     // Catch:{ all -> 0x0bc3 }
            java.lang.String r13 = m2812b(r4, r13, r5)     // Catch:{ all -> 0x0bc3 }
            if (r13 == 0) goto L_0x06d3
            android.net.Uri r13 = p000.blk.m3616a(r3, r13)     // Catch:{ all -> 0x0bc3 }
            goto L_0x06d5
        L_0x06d3:
            r13 = 0
        L_0x06d5:
            java.util.regex.Pattern r14 = p000.bck.f3315z     // Catch:{ all -> 0x0bc3 }
            java.lang.String r50 = m2812b(r4, r14, r5)     // Catch:{ all -> 0x0bc3 }
            java.util.regex.Pattern r14 = p000.bck.f3285F     // Catch:{ all -> 0x0bc3 }
            boolean r14 = m2814c(r4, r14)     // Catch:{ all -> 0x0bc3 }
            r79 = r12
            java.util.regex.Pattern r12 = p000.bck.f3286G     // Catch:{ all -> 0x0bc3 }
            boolean r12 = m2814c(r4, r12)     // Catch:{ all -> 0x0bc3 }
            if (r12 != 0) goto L_0x06ec
            goto L_0x06ee
        L_0x06ec:
            r14 = r14 | 2
        L_0x06ee:
            java.util.regex.Pattern r12 = p000.bck.f3284E     // Catch:{ all -> 0x0bc3 }
            boolean r12 = m2814c(r4, r12)     // Catch:{ all -> 0x0bc3 }
        ...
        L_0x06f9:
            ...
            r49 = r12
        L_0x06fe:
            java.util.regex.Pattern r12 = p000.bck.f3282C     // Catch:{ all -> 0x0bc3 }
            java.lang.String r12 = m2812b(r4, r12, r5)     // Catch:{ all -> 0x0bc3 }
            boolean r14 = android.text.TextUtils.isEmpty(r12)     // Catch:{ all -> 0x0bc3 }
            if (r14 != 0) goto L_0x0740
            java.lang.String r14 = ","
            java.lang.String[] r12 = p000.blm.m3658a(r12, r14)     // Catch:{ all -> 0x0bc3 }
            java.lang.String r14 = "public.accessibility.describes-video"
            boolean r14 = p000.blm.m3653a(r12, r14)     // Catch:{ all -> 0x0bc3 }
        ...
        L_0x071d:
            ...
            boolean r0 = p000.blm.m3653a(r12, r0)     // Catch:{ all -> 0x0bc3 }
        ...
        L_0x0743:
            ...
            r22 = r3
            r12 = 1
            atv[] r3 = new p000.atv[r12]     // Catch:{ all -> 0x0bc3 }
            ...
            java.util.regex.Pattern r3 = p000.bck.f3314y     // Catch:{ all -> 0x0bc3 }
            java.lang.String r3 = m2810a(r4, r3, r5)     // Catch:{ all -> 0x0bc3 }
            int r12 = r3.hashCode()
            switch(r12) {
                case -959297733: goto L_0x07af;
                case -333210994: goto L_0x07a5;
        ...
        L_0x07ba:
            ...
            goto L_0x08c5
        L_0x07c7:
            java.util.regex.Pattern r0 = p000.bck.f3283D     // Catch:{ all -> 0x0bc3 }
            java.lang.String r0 = m2810a(r4, r0, r5)     // Catch:{ all -> 0x0bc3 }
        ...
        L_0x07fd:
            ...
            r46 = r14
            r47 = r50
            akh r0 = p000.akh.m741a(r39, r40, r41, r42, r43, r44, r45, r46, r47, r48)     // Catch:{ all -> 0x0bc3 }
        ...
        L_0x0816:
            ...
            r45 = r14
            r46 = r50
            akh r3 = p000.akh.m738a(r39, r40, r41, r42, r43, r44, r45, r46)     // Catch:{ all -> 0x0bc3 }
            akh r0 = r3.mo425a(r0)     // Catch:{ all -> 0x0bc3 }
        ...
        L_0x083b:
            ...
            bce r15 = (p000.bce) r15     // Catch:{ all -> 0x0bc3 }
            java.lang.String r12 = r15.f3239d     // Catch:{ all -> 0x0bc3 }
        ...
        L_0x0855:
            ...
            akh r3 = r15.f3237b     // Catch:{ all -> 0x0bc3 }
            java.lang.String r3 = r3.f553f     // Catch:{ all -> 0x0bc3 }
            r9 = 1
            java.lang.String r3 = p000.blm.m3637a(r3, r9)     // Catch:{ all -> 0x0bc3 }
            r43 = r3
            goto L_0x0866
        L_0x0863:
            r43 = 0
        L_0x0866:
            ...
            java.lang.String r3 = p000.bkt.m3520f(r43)     // Catch:{ all -> 0x0bc3 }
            goto L_0x086f
        L_0x086d:
            r3 = 0
        L_0x086f:
            java.util.regex.Pattern r9 = p000.bck.f3296g     // Catch:{ all -> 0x0bc3 }
            java.lang.String r4 = m2812b(r4, r9, r5)     // Catch:{ all -> 0x0bc3 }
            if (r4 == 0) goto L_0x089b
            java.lang.String r9 = "/"
            java.lang.String[] r9 = p000.blm.m3670b(r4, r9)     // Catch:{ all -> 0x0bc3 }
            r12 = 0
        ...
        L_0x089f:
            ...
            r48 = r49
            r49 = r14
            akh r3 = p000.akh.m742a(r39, r40, r41, r42, r43, r44, r45, r46, r47, r48, r49, r50)     // Catch:{ all -> 0x0bc3 }
        ...
        L_0x08ca:
            ...
            bce r4 = (p000.bce) r4     // Catch:{ all -> 0x0bc3 }
            java.lang.String r12 = r4.f3238c     // Catch:{ all -> 0x0bc3 }
            boolean r12 = r9.equals(r12)     // Catch:{ all -> 0x0bc3 }
        ...
        L_0x08e3:
            ...
            akh r3 = r4.f3237b     // Catch:{ all -> 0x0bc3 }
            java.lang.String r4 = r3.f553f     // Catch:{ all -> 0x0bc3 }
            r12 = 2
            java.lang.String r4 = p000.blm.m3637a(r4, r12)     // Catch:{ all -> 0x0bc3 }
            int r9 = r3.f561n     // Catch:{ all -> 0x0bc3 }
            int r15 = r3.f562o     // Catch:{ all -> 0x0bc3 }
            float r3 = r3.f563p     // Catch:{ all -> 0x0bc3 }
            r47 = r3
            r43 = r4
            r45 = r9
            r46 = r15
        ...
        L_0x0914:
            ...
            r40 = r11
            r50 = r14
            akh r3 = p000.akh.m739a(r39, r40, r41, r42, r43, r44, r45, r46, r47, r48, r49, r50)     // Catch:{ all -> 0x0bc3 }
            akh r0 = r3.mo425a(r0)     // Catch:{ all -> 0x0bc3 }
        ...
        L_0x0965:
            ...
            r23 = r15
            r12 = 2
            java.lang.String r2 = r0.mo1763b()     // Catch:{ all -> 0x0bc3 }
            r3 = r69
        ...
        L_0x0988:
            ...
            java.util.regex.Pattern r13 = p000.bck.f3280A     // Catch:{ all -> 0x0bc3 }
            java.lang.String r13 = m2810a(r2, r13, r5)     // Catch:{ all -> 0x0bc3 }
            java.util.regex.Pattern r14 = p000.bck.f3287H     // Catch:{ all -> 0x0bc3 }
            java.lang.String r2 = m2810a(r2, r14, r5)     // Catch:{ all -> 0x0bc3 }
        ...
        L_0x09cc:
            ...
            java.util.regex.Pattern r14 = p000.bck.f3310u     // Catch:{ all -> 0x0bc3 }
            java.lang.String r14 = m2809a(r2, r14, r11, r5)     // Catch:{ all -> 0x0bc3 }
            anp r14 = m2806a(r2, r14, r5)     // Catch:{ all -> 0x0bc3 }
            if (r14 == 0) goto L_0x0a0d
            java.util.regex.Pattern r15 = p000.bck.f3309t     // Catch:{ all -> 0x0bc3 }
            java.lang.String r2 = m2810a(r2, r15, r5)     // Catch:{ all -> 0x0bc3 }
            java.lang.String r2 = m2807a(r2)     // Catch:{ all -> 0x0bc3 }
            anq r15 = new anq     // Catch:{ all -> 0x0bc3 }
            r69 = r3
            r12 = 1
            anp[] r3 = new p000.anp[r12]     // Catch:{ all -> 0x0bc3 }
            r12 = 0
        ...
        L_0x0a25:
            ...
            r15 = r23 | r12
            java.util.regex.Pattern r12 = p000.bck.f3295f     // Catch:{ all -> 0x0bc3 }
            int r12 = m2805a(r2, r12)     // Catch:{ all -> 0x0bc3 }
            java.util.regex.Pattern r14 = p000.bck.f3290a     // Catch:{ all -> 0x0bc3 }
            java.lang.String r14 = m2812b(r2, r14, r5)     // Catch:{ all -> 0x0bc3 }
            if (r14 != 0) goto L_0x0a46
            goto L_0x0a4a
        L_0x0a46:
            int r12 = java.lang.Integer.parseInt(r14)     // Catch:{ all -> 0x0bc3 }
        L_0x0a4a:
            java.util.regex.Pattern r14 = p000.bck.f3297h     // Catch:{ all -> 0x0bc3 }
            java.lang.String r43 = m2812b(r2, r14, r5)     // Catch:{ all -> 0x0bc3 }
            java.util.regex.Pattern r14 = p000.bck.f3298i     // Catch:{ all -> 0x0bc3 }
            java.lang.String r14 = m2812b(r2, r14, r5)     // Catch:{ all -> 0x0bc3 }
        ...
        L_0x0a7e:
            ...
            r46 = -1
        L_0x0a87:
            java.util.regex.Pattern r1 = p000.bck.f3299j     // Catch:{ all -> 0x0bc3 }
            java.lang.String r1 = m2812b(r2, r1, r5)     // Catch:{ all -> 0x0bc3 }
        ...
        L_0x0a96:
            ...
            r47 = -1082130432(0xffffffffbf800000, float:-1.0)
        L_0x0a9a:
            java.util.regex.Pattern r1 = p000.bck.f3291b     // Catch:{ all -> 0x0bc3 }
            java.lang.String r1 = m2812b(r2, r1, r5)     // Catch:{ all -> 0x0bc3 }
            java.util.regex.Pattern r14 = p000.bck.f3292c     // Catch:{ all -> 0x0bc3 }
            java.lang.String r14 = m2812b(r2, r14, r5)     // Catch:{ all -> 0x0bc3 }
            r19 = r3
            java.util.regex.Pattern r3 = p000.bck.f3293d     // Catch:{ all -> 0x0bc3 }
            java.lang.String r3 = m2812b(r2, r3, r5)     // Catch:{ all -> 0x0bc3 }
            r21 = r4
            java.util.regex.Pattern r4 = p000.bck.f3294e     // Catch:{ all -> 0x0bc3 }
            java.lang.String r2 = m2812b(r2, r4, r5)     // Catch:{ all -> 0x0bc3 }
            boolean r4 = r0.mo1762a()     // Catch:{ all -> 0x0bc3 }
            if (r4 == 0) goto L_0x0b45
            java.lang.String r4 = r0.mo1763b()     // Catch:{ all -> 0x0bc3 }
            java.lang.String r4 = m2808a(r4, r5)     // Catch:{ all -> 0x0bc3 }
            r24 = r0
            r0 = r22
            android.net.Uri r4 = p000.blk.m3616a(r0, r4)     // Catch:{ all -> 0x0bc3 }
            ...
            r50 = 0
            r44 = r12
            akh r31 = p000.akh.m739a(r39, r40, r41, r42, r43, r44, r45, r46, r47, r48, r49, r50)     // Catch:{ all -> 0x0bc3 }
            r22 = r0
        ...
        L_0x0bcd:
            goto L_0x0bcc
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.bck.mo1648a(android.net.Uri, java.io.InputStream):java.lang.Object");
    }

    /* renamed from: b */
    private static double m2811b(String str, Pattern pattern) {
        return Double.parseDouble(m2810a(str, pattern, Collections.emptyMap()));
    }

    /* renamed from: a */
    private static anp m2806a(String str, String str2, Map map) {
        String a = m2809a(str, f3311v, "1", map);
        if ("urn:uuid:edef8ba9-79d6-4ace-a3c8-27dcd51d21ed".equals(str2)) {
            String a2 = m2810a(str, f3312w, map);
            return new anp(aja.f431c, "video/mp4", Base64.decode(a2.substring(a2.indexOf(44)), 0));
        } else if ("com.widevine".equals(str2)) {
            return new anp(aja.f431c, "hls", blm.m3674c(str));
        } else {
            if (!"com.microsoft.playready".equals(str2) || !"1".equals(a)) {
                return null;
            }
            String a3 = m2810a(str, f3312w, map);
            return new anp(aja.f432d, "video/mp4", bty.m4185a(aja.f432d, Base64.decode(a3.substring(a3.indexOf(44)), 0)));
        }
    }

    /* renamed from: a */
    private static String m2807a(String str) {
        return (!"SAMPLE-AES-CENC".equals(str) && !"SAMPLE-AES-CTR".equals(str)) ? "cbcs" : "cenc";
    }

    /* renamed from: a */
    private static int m2805a(String str, Pattern pattern) {
        return Integer.parseInt(m2810a(str, pattern, Collections.emptyMap()));
    }

    /* renamed from: c */
    private static boolean m2814c(String str, Pattern pattern) {
    ...
    /* renamed from: a */
    private static String m2809a(String str, Pattern pattern, String str2, Map map) {
        Matcher matcher = pattern.matcher(str);
        if (matcher.find()) {
            str2 = matcher.group(1);
        }
        return (map.isEmpty() || str2 == null) ? str2 : m2808a(str2, map);
    }

    /* renamed from: b */
    private static String m2812b(String str, Pattern pattern, Map map) {
        return m2809a(str, pattern, null, map);
    }

    /* renamed from: a */
    private static String m2810a(String str, Pattern pattern, Map map) {
        String b = m2812b(str, pattern, map);
        if (b != null) {
            return b;
        }
    ...
    /* renamed from: a */
    private static String m2808a(String str, Map map) {
        Matcher matcher = f3289J.matcher(str);
    ...
    /* renamed from: a */
    private static int m2804a(BufferedReader bufferedReader, boolean z, int i) {
        while (i != -1 && Character.isWhitespace(i) && (z || !blm.m3648a(i))) {

...
public final class big extends bho implements bio {
    ...
    /* renamed from: a */
    private static final Pattern f4055a = Pattern.compile("^bytes (\\d+)-(\\d+)/(\\d+)$");

    /* renamed from: b */
    private static final AtomicReference f4056b = new AtomicReference();

    /* renamed from: c */
    private final String f4057c;

    /* renamed from: d */
    private final bin f4058d;

    /* renamed from: e */
    private final bin f4059e = new bin();

    /* renamed from: f */
    private HttpURLConnection f4060f;

    /* renamed from: g */
    private InputStream f4061g;
    ...
    public final void mo1503c() {
        try {
            if (this.f4061g != null) {
                HttpURLConnection httpURLConnection = this.f4060f;
                long j = this.f4065k;
                if (j != -1) {
                    j -= this.f4067m;
                }
                if (blm.f4293a == 19 || blm.f4293a == 20) {
                    try {
    ...
    public final long mo1499a(p000.bhy r23) {
        /*
            r22 = this;
            r1 = r22
            r2 = r23
            ...
            android.net.Uri r6 = r2.f3998a     // Catch:{ IOException -> 0x027d }
            java.lang.String r6 = r6.toString()     // Catch:{ IOException -> 0x027d }
            r0.<init>(r6)     // Catch:{ IOException -> 0x027d }
            int r6 = r2.f3999b     // Catch:{ IOException -> 0x027d }
            long r7 = r2.f4002e     // Catch:{ IOException -> 0x027d }
            long r9 = r2.f4003f     // Catch:{ IOException -> 0x027d }
            r11 = 1
            boolean r12 = r2.mo1957a(r11)     // Catch:{ IOException -> 0x027d }
            java.util.Map r13 = r2.f4000c     // Catch:{ IOException -> 0x027d }
            ...
            bin r15 = r1.f4058d     // Catch:{ IOException -> 0x027d }
            java.util.Map r15 = r15.mo1977a()     // Catch:{ IOException -> 0x027d }
            r14.putAll(r15)     // Catch:{ IOException -> 0x027d }
            bin r15 = r1.f4059e     // Catch:{ IOException -> 0x027d }
            java.util.Map r15 = r15.mo1977a()     // Catch:{ IOException -> 0x027d }
            r14.putAll(r15)     // Catch:{ IOException -> 0x027d }
        ...
        L_0x00bf:
            ...
            java.lang.String r5 = r1.f4057c     // Catch:{ IOException -> 0x027d }
        ...
        L_0x00d1:
            ...
            java.lang.String r4 = p000.bhy.m3291b(r6)     // Catch:{ IOException -> 0x027d }
            r0.setRequestMethod(r4)     // Catch:{ IOException -> 0x027d }
            r0.connect()     // Catch:{ IOException -> 0x027d }
            r1.f4060f = r0     // Catch:{ IOException -> 0x027d }
            int r0 = r0.getResponseCode()     // Catch:{ IOException -> 0x0259 }
            r1.f4063i = r0     // Catch:{ IOException -> 0x0259 }
            java.net.HttpURLConnection r0 = r1.f4060f     // Catch:{ IOException -> 0x0259 }
        ...
        L_0x00fa:
            ...
            java.net.HttpURLConnection r0 = r1.f4060f
            r0.getContentType()
            int r0 = r1.f4063i
        ...
        L_0x0127:
            ...
            java.net.HttpURLConnection r4 = r1.f4060f
        ...
        L_0x016b:
            ...
            java.util.regex.Pattern r0 = p000.big.f4055a
        ...
        L_0x029f:
            goto L_0x029e
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.big.mo1499a(bhy):long");
    }

    /* JADX WARNING: Removed duplicated region for block: B:10:0x0028 A[Catch:{ IOException -> 0x0096 }] */
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final int mo1498a(byte[] r9, int r10, int r11) {
        /*
            r8 = this;
            long r0 = r8.f4066l     // Catch:{ IOException -> 0x0096 }
            long r2 = r8.f4064j     // Catch:{ IOException -> 0x0096 }
            r4 = 0
            r5 = -1
            int r6 = (r0 > r2 ? 1 : (r0 == r2 ? 0 : -1))
            if (r6 == 0) goto L_0x0058
            java.util.concurrent.atomic.AtomicReference r0 = p000.big.f4056b     // Catch:{ IOException -> 0x0096 }
            r1 = 0
        ...
        L_0x001a:
            long r1 = r8.f4066l     // Catch:{ IOException -> 0x0096 }
            long r6 = r8.f4064j     // Catch:{ IOException -> 0x0096 }
            int r3 = (r1 > r6 ? 1 : (r1 == r6 ? 0 : -1))
            if (r3 != 0) goto L_0x0028
            java.util.concurrent.atomic.AtomicReference r1 = p000.big.f4056b     // Catch:{ IOException -> 0x0096 }
        ...
        L_0x0028:
            ...
            java.io.InputStream r1 = r8.f4061g     // Catch:{ IOException -> 0x0096 }
            ...
            long r2 = r8.f4066l     // Catch:{ IOException -> 0x0096 }
            long r6 = (long) r1     // Catch:{ IOException -> 0x0096 }
            long r2 = r2 + r6
            r8.f4066l = r2     // Catch:{ IOException -> 0x0096 }
            r8.mo1942a(r1)     // Catch:{ IOException -> 0x0096 }
            goto L_0x0015
        L_0x004c:
        ...
        L_0x0058:
            ...
            long r0 = r8.f4065k     // Catch:{ IOException -> 0x0096 }
            r2 = -1
            int r4 = (r0 > r2 ? 1 : (r0 == r2 ? 0 : -1))
            if (r4 != 0) goto L_0x0063
            goto L_0x0072
        L_0x0063:
            long r6 = r8.f4067m     // Catch:{ IOException -> 0x0096 }
            long r0 = r0 - r6
            r6 = 0
        ...
        L_0x0072:
            java.io.InputStream r0 = r8.f4061g     // Catch:{ IOException -> 0x0096 }
            int r4 = r0.read(r9, r10, r11)     // Catch:{ IOException -> 0x0096 }
            if (r4 == r5) goto L_0x0084
            long r9 = r8.f4067m     // Catch:{ IOException -> 0x0096 }
            long r0 = (long) r4     // Catch:{ IOException -> 0x0096 }
            long r9 = r9 + r0
            r8.f4067m = r9     // Catch:{ IOException -> 0x0096 }
            r8.mo1942a(r4)     // Catch:{ IOException -> 0x0096 }
            goto L_0x0094
        L_0x0084:
            long r9 = r8.f4065k     // Catch:{ IOException -> 0x0096 }
        ...
        L_0x009e:
            goto L_0x009d
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.big.mo1498a(byte[], int, int):int");
    }
}

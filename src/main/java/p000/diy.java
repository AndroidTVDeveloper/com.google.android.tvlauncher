...
abstract class diy {
    ...
    /* renamed from: a */
    private static final Logger f8666a = Logger.getLogger(din.class.getName());

    /* renamed from: b */
    private static final String f8667b = "dia";

    /* access modifiers changed from: protected */
    /* renamed from: a */
    public abstract dis mo4490a();
    ...
    static dis m6647a(Class cls) {
        ...
        try {
            return (dis) cls.cast(((diy) Class.forName(str, true, classLoader).getConstructor(new Class[0]).newInstance(new Object[0])).mo4490a());
            ...
            while (it.hasNext()) {
                try {
                    arrayList.add(cls.cast(((diy) it.next()).mo4490a()));

...
public final class blk {
    ...
    /* renamed from: a */
    public static void m3619a(String str) {
        if (blm.f4293a >= 18) {
    ...
    /* renamed from: b */
    private static int[] m3621b(String str) {
        int i;
        int[] iArr = new int[4];
    ...
    /* renamed from: a */
    private static String m3617a(StringBuilder sb, int i, int i2) {
        int i3;
        if (i >= i2) {
            return sb.toString();
        }
    ...
    /* renamed from: b */
    public static String m3620b(String str, String str2) {
        int i;
        ...
        if (b[3] == 0) {
            ...
            sb.append(str2);
            return m3617a(sb, b[1] + i2, i2 + b[2]);
        } else if (str2.charAt(0) == '/') {
            sb.append((CharSequence) str, 0, b2[1]);
            sb.append(str2);
            int i3 = b2[1];
            return m3617a(sb, i3, b[2] + i3);
        } else {
            int i4 = b2[0];
            int i5 = b2[1];
            if (i4 + 2 >= i5 || i5 != b2[2]) {
                ...
                sb.append(str2);
                return m3617a(sb, b2[1], i + b[2]);
            }
            sb.append((CharSequence) str, 0, i5);
            sb.append('/');
            sb.append(str2);
            int i6 = b2[1];
            return m3617a(sb, i6, b[2] + i6 + 1);
        }
    }

    /* renamed from: a */
    public static Uri m3616a(String str, String str2) {
        return Uri.parse(m3620b(str, str2));
    }
}

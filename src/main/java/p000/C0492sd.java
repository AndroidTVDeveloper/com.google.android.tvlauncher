...
final class C0492sd {
    ...
    /* renamed from: a */
    public static final Matrix f10322a = new Matrix();

    /* renamed from: b */
    public Paint f10323b;

    /* renamed from: c */
    public Paint f10324c;

    /* renamed from: d */
    public final C0490sb f10325d;
    ...
    /* renamed from: k */
    public final C0067cl f10332k;

    /* renamed from: l */
    private final Path f10333l;

    /* renamed from: m */
    private final Path f10334m;

    /* renamed from: n */
    private final Matrix f10335n;

    /* renamed from: o */
    private PathMeasure f10336o;
    ...
    public C0492sd() {
        ...
        this.f10330i = null;
        this.f10331j = null;
        this.f10332k = new C0067cl();
        this.f10325d = new C0490sb();
        this.f10333l = new Path();
        this.f10334m = new Path();
    }

    public C0492sd(C0492sd sdVar) {
        this.f10335n = new Matrix();
        this.f10326e = 0.0f;
        this.f10327f = 0.0f;
        this.f10328g = 0.0f;
        ...
        this.f10331j = null;
        this.f10332k = new C0067cl();
        this.f10325d = new C0490sb(sdVar.f10325d, this.f10332k);
        this.f10333l = new Path(sdVar.f10333l);
        this.f10334m = new Path(sdVar.f10334m);
        this.f10326e = sdVar.f10326e;
        this.f10327f = sdVar.f10327f;
        this.f10328g = sdVar.f10328g;
        this.f10329h = sdVar.f10329h;
        this.f10337p = sdVar.f10337p;
        this.f10330i = sdVar.f10330i;
        String str = sdVar.f10330i;
        if (str != null) {
            this.f10332k.put(str, this);
        }
        this.f10331j = sdVar.f10331j;
    }
    ...
    public final void mo5879a(p000.C0490sb r40, android.graphics.Matrix r41, android.graphics.Canvas r42, int r43, int r44) {
        /*
            r39 = this;
            r6 = r39
            r7 = r40
            r8 = r42
            android.graphics.Matrix r0 = r7.f10308a
            r1 = r41
            r0.set(r1)
            android.graphics.Matrix r0 = r7.f10308a
            android.graphics.Matrix r1 = r7.f10317j
            r0.preConcat(r1)
            r42.save()
            r9 = 0
            r10 = 0
        L_0x0019:
            java.util.ArrayList r0 = r7.f10309b
            int r0 = r0.size()
            if (r10 >= r0) goto L_0x065d
            java.util.ArrayList r0 = r7.f10309b
            java.lang.Object r0 = r0.get(r10)
            bru r0 = (p000.bru) r0
            boolean r1 = r0 instanceof p000.C0490sb
            if (r1 == 0) goto L_0x0041
            r1 = r0
            sb r1 = (p000.C0490sb) r1
            android.graphics.Matrix r2 = r7.f10308a
            r0 = r39
            r3 = r42
            r4 = r43
            r5 = r44
            r0.mo5879a(r1, r2, r3, r4, r5)
            r32 = r10
            goto L_0x0657
        L_0x0041:
            boolean r1 = r0 instanceof p000.C0491sc
            if (r1 == 0) goto L_0x0655
            sc r0 = (p000.C0491sc) r0
            r1 = r43
            float r2 = (float) r1
            float r3 = r6.f10328g
            float r2 = r2 / r3
            ...
            android.graphics.Matrix r11 = r7.f10308a
            android.graphics.Matrix r12 = r6.f10335n
            r12.set(r11)
            android.graphics.Matrix r12 = r6.f10335n
            r12.postScale(r2, r4)
            r2 = 4
        ...
        L_0x00a8:
            ...
            android.graphics.Path r4 = r6.f10333l
            r4.reset()
            bf[] r11 = r0.f10319l
        ...
        L_0x03f4:
            ...
            r19 = r15
            r20 = r1
            p000.C0034bf.m3016a(r18, r19, r20, r21, r22, r23, r24, r25, r26, r27)
            r2 = r13[r2]
            float r15 = r15 + r2
            r2 = r13[r3]
            float r1 = r1 + r2
        ...
        L_0x04ed:
            ...
            r32 = r10
        L_0x04f1:
            android.graphics.Path r1 = r6.f10333l
            android.graphics.Path r2 = r6.f10334m
            r2.reset()
            boolean r2 = r0.mo5842a()
        ...
        L_0x0509:
            r2.setFillType(r0)
            android.graphics.Path r0 = r6.f10334m
            android.graphics.Matrix r2 = r6.f10335n
            r0.addPath(r1, r2)
            android.graphics.Path r0 = r6.f10334m
            r8.clipPath(r0)
            r9 = 0
        ...
        L_0x052f:
            ...
            float r7 = r7 + r4
            float r7 = r7 % r3
            android.graphics.PathMeasure r3 = r6.f10336o
        ...
        L_0x0542:
            ...
            android.graphics.PathMeasure r4 = r6.f10336o
            r10 = 1
            r4.getSegment(r2, r3, r1, r10)
            android.graphics.PathMeasure r2 = r6.f10336o
            r3 = 0
        ...
        L_0x0573:
            android.graphics.Path r2 = r6.f10334m
            android.graphics.Matrix r3 = r6.f10335n
            r2.addPath(r1, r3)
            au r1 = r0.f10299c
            boolean r1 = r1.mo1359c()
            r2 = 1132396544(0x437f0000, float:255.0)
            r3 = 255(0xff, float:3.57E-43)
            r4 = 0
            if (r1 == 0) goto L_0x05e1
            au r1 = r0.f10299c
            android.graphics.Paint r7 = r6.f10324c
        ...
        L_0x059a:
            android.graphics.Paint r7 = r6.f10324c
            boolean r10 = r1.mo1356a()
            if (r10 == 0) goto L_0x05b8
            android.graphics.Shader r1 = r1.f2414a
            android.graphics.Matrix r10 = r6.f10335n
        ...
        L_0x05b8:
            ...
            r7.setAlpha(r3)
            int r1 = r1.f2415b
            float r10 = r0.f10301e
            int r1 = p000.C0495sg.m8289a(r1, r10)
            r7.setColor(r1)
        L_0x05ca:
            r7.setColorFilter(r4)
            android.graphics.Path r1 = r6.f10334m
            int r10 = r0.f10321n
        ...
        L_0x05e1:
            ...
            au r1 = r0.f10297a
            android.graphics.Paint r7 = r6.f10323b
        ...
        L_0x05fc:
            android.graphics.Paint r7 = r6.f10323b
            android.graphics.Paint$Join r10 = r0.f10306j
            if (r10 == 0) goto L_0x0605
            r7.setStrokeJoin(r10)
        L_0x0605:
            android.graphics.Paint$Cap r10 = r0.f10305i
            if (r10 == 0) goto L_0x060c
            r7.setStrokeCap(r10)
        L_0x060c:
            float r10 = r0.f10307k
        ...
        L_0x062d:
            ...
            int r1 = r1.f2415b
            float r2 = r0.f10300d
            int r1 = p000.C0495sg.m8289a(r1, r2)
            r7.setColor(r1)
        L_0x063f:
            r7.setColorFilter(r4)
            float r0 = r0.f10298b
        ...
        L_0x065d:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.C0492sd.mo5879a(sb, android.graphics.Matrix, android.graphics.Canvas, int, int):void");
    }

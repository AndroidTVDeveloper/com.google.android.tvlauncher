...
/* renamed from: ux */
/* compiled from: PG */
public final class C0566ux implements C0549ug {

    /* renamed from: a */
    private final Uri f10560a;

    /* renamed from: b */
    private final C0568uz f10561b;

    /* renamed from: c */
    private InputStream f10562c;

    private C0566ux(Uri uri, C0568uz uzVar) {
        this.f10560a = uri;
        this.f10561b = uzVar;
    }
    ...
    /* renamed from: a */
    public static C0566ux m8460a(Context context, Uri uri, C0567uy uyVar) {
        return new C0566ux(uri, new C0568uz(C0497si.m8291a(context).f10364c.mo5925a(), uyVar, C0497si.m8291a(context).f10365d, context.getContentResolver()));
    }

    /* renamed from: b */
    public final void mo8b() {
        InputStream inputStream = this.f10562c;
        if (inputStream != null) {
            try {
                inputStream.close();
            } catch (IOException e) {
    ...
    public final void mo7a(p000.C0501sm r9, p000.C0548uf r10) {
        /*
            r8 = this;
            uz r9 = r8.f10561b     // Catch:{ FileNotFoundException -> 0x00ec }
            android.net.Uri r0 = r8.f10560a     // Catch:{ FileNotFoundException -> 0x00ec }
            r1 = 0
            uy r2 = r9.f10563a     // Catch:{ SecurityException -> 0x0030, all -> 0x0029 }
            android.database.Cursor r2 = r2.mo6014a(r0)     // Catch:{ SecurityException -> 0x0030, all -> 0x0029 }
        ...
        L_0x0037:
            ...
            android.content.ContentResolver r9 = r9.f10565c     // Catch:{ NullPointerException -> 0x005d }
        ...
        L_0x00a0:
            ...
            uz r2 = r8.f10561b     // Catch:{ FileNotFoundException -> 0x00ec }
            android.net.Uri r3 = r8.f10560a     // Catch:{ FileNotFoundException -> 0x00ec }
            android.content.ContentResolver r4 = r2.f10565c     // Catch:{ IOException -> 0x00d0, NullPointerException -> 0x00ce, all -> 0x00c5 }
            java.io.InputStream r1 = r4.openInputStream(r3)     // Catch:{ IOException -> 0x00d0, NullPointerException -> 0x00ce, all -> 0x00c5 }
            java.util.List r3 = r2.f10566d     // Catch:{ IOException -> 0x00c3, NullPointerException -> 0x00c1, all -> 0x00be }
            xe r2 = r2.f10564b     // Catch:{ IOException -> 0x00c3, NullPointerException -> 0x00c1, all -> 0x00be }
            int r2 = p000.bro.m4077b(r3, r1, r2)     // Catch:{ IOException -> 0x00c3, NullPointerException -> 0x00c1, all -> 0x00be }
        ...
        L_0x00de:
            ...
            r9 = r0
        L_0x00e6:
            r8.f10562c = r9     // Catch:{ FileNotFoundException -> 0x00ec }
            r10.mo22a(r9)
            return
        L_0x00ec:
            r9 = move-exception
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.C0566ux.mo7a(sm, uf):void");
    }
}

...
public final class C0034bf {
    ...
    public C0034bf(char c, float[] fArr) {
        this.f3612a = c;
        this.f3613b = fArr;
    }

    public C0034bf(C0034bf bfVar) {
        this.f3612a = bfVar.f3612a;
        float[] fArr = bfVar.f3613b;
        this.f3613b = C0035bg.m3113a(fArr, fArr.length);
    }

    /* renamed from: a */
    public static void m3016a(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
        double d;
        double d2;
        float f8 = f;
        float f9 = f3;
        ...
        if (d23 != 0.0d) {
            ...
            if (d24 < 0.0d) {
                ...
                m3016a(path, f, f2, f3, f4, f5 * sqrt, f6 * sqrt, f7, z, z2);
                return;
            }

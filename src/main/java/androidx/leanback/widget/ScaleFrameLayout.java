...
public class ScaleFrameLayout extends FrameLayout {
    ...
    public final void addView(View view, int i, ViewGroup.LayoutParams layoutParams) {
        ...
        view.setScaleX(this.f1245c);
        view.setScaleY(this.f1245c);
    }
    ...
    /* renamed from: a */
    private static int m1421a(int i, float f) {
    ...
    public final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (scaleFrameLayout.f1243a != 1.0f) {
            int paddingLeft = getPaddingLeft();
            float f2 = scaleFrameLayout.f1243a;
        ...
        if (scaleFrameLayout.f1244b != 1.0f) {
            int paddingTop = getPaddingTop();
            float f3 = scaleFrameLayout.f1244b;
    ...
    public final void onMeasure(int i, int i2) {
        float f = this.f1243a;
        if (f == 1.0f && this.f1244b == 1.0f) {
            super.onMeasure(i, i2);
            return;
        }
        super.onMeasure(m1421a(i, f), m1421a(i2, this.f1244b));
        setMeasuredDimension((int) ((((float) getMeasuredWidth()) * this.f1243a) + 0.5f), (int) ((((float) getMeasuredHeight()) * this.f1244b) + 0.5f));
    }

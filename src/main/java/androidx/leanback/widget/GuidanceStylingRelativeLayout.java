...
class GuidanceStylingRelativeLayout extends RelativeLayout {
    ...
    public GuidanceStylingRelativeLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        this.f1195a = m1405a(context);
    }

    /* renamed from: a */
    public static float m1405a(Context context) {
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(C0324ly.f9931a);
    ...
    public final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        int measuredHeight = (int) ((((float) getMeasuredHeight()) * this.f1195a) / 100.0f);

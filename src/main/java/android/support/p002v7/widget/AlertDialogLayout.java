...
/* compiled from: PG */
public class AlertDialogLayout extends C0237is {
    ...
    public final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i11 = 0; i11 < childCount; i11++) {
            ...
            if (!(childAt == null || childAt.getVisibility() == 8)) {
                ...
                int i12 = irVar.f9629h;
                if (i12 < 0) {
                    i12 = i9;
                }
                int a = C0122el.m7244a(i12, C0107dx.m7209f(this)) & 7;
                if (a == 1) {
        ...
        if (mode2 != 1073741824) {
            ...
            for (int i13 = 0; i13 < childCount; i13++) {
                ...
                if (childAt3.getVisibility() != 8) {
                    C0236ir irVar = (C0236ir) childAt3.getLayoutParams();
                    if (irVar.width == -1) {
    ...
    /* renamed from: a */
    private static int m1282a(View view) {
        int h = C0107dx.m7211h(view);
        if (h > 0) {
            return h;
        }
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m1282a(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }

...
public class ButtonBarLayout extends LinearLayout {
    ...
    /* renamed from: b */
    private int f1017b = -1;

    public ButtonBarLayout(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0128er.f9170h);
        if (Build.VERSION.SDK_INT >= 29) {
            saveAttributeDataForStyleable(context, C0128er.f9170h, attributeSet, obtainStyledAttributes, 0, 0);
        }
        this.f1016a = obtainStyledAttributes.getBoolean(0, true);
    ...
    /* renamed from: a */
    private final int m1283a(int i) {
    ...
    public final void onMeasure(int r6, int r7) {
        /*
            ...
            boolean r1 = r5.f1016a
            r2 = 0
            if (r1 == 0) goto L_0x0018
            int r1 = r5.f1017b
            if (r0 <= r1) goto L_0x0016
            boolean r1 = r5.m1285a()
        ...
        L_0x0032:
            ...
            boolean r0 = r5.f1016a
            if (r0 == 0) goto L_0x004e
            boolean r0 = r5.m1285a()
            if (r0 != 0) goto L_0x004e
